...
* Current: Full-time artist, Member of ADAGP (International Copyright Society), Korean Fine Arts Association, Songpa Artists Association, Nurimuri`,
  ...
  김상구: {
    name_en: 'Kim Sanggu',
    profile: `김상구는 1945년 서울에서 태어나 홍대 서양화과와 동대학원을 졸업하였다. 현대 산업사회의 기계화 시대에 역행하는 듯한 목판화와 철저한 수공 공정을 고수하는 보기 드문 작가이다. 목각예술은 현란한 세련미 대신 우직함과 단순함을 특징으로 하는 동양적 장인정신과 서민적 속성에 뿌리를 둔다.\n이런 점에서 그의 목판화 작업은 가장 인간적인 작업 영역이며, 우리 사회에 인간미를 더해주는 시정과 같은 것으로 이해된다.\n그의 목판화 세계는 "화려한 것보다는 투박한 것, 복잡한 것보다는 단순한 가운데 스며드는 토담과 같은 것, 입체적 표현보다는 평면적인 것, 흑백의 대비, 가득 차 있는 것보다는 여백의 미"로 함축할 수 있다.\n70년대 후반 이래 발표 활동을 이어온 화가의 근작은 다색판화로 엮어지고 있다. 세심한 작업이 요구되는 다색판화로 표현 영역을 넓히면서도 꾸준하고 깊이 있는 작품을 추구한다.`,
...
National Art Museum of China, China Printmaking Museum, Lu Xun Academy of Fine Arts Museum, etc.`,
  ...
  김호성: {
    name_en: 'Kim Hoseong',
    profile: `작가소개\n경희대학교 사학과를 졸업하고 중앙대학교 사진학과를 나와 현대미술가로 활동하고 있다. 초기에는 사진과 영상을 기반으로 현대인의 욕망과 방황을 다룬 작업을 주로 선보였다. 2018-2019년에는 24시간 출입 가능한 무인 갤러리를 운영하며 매달 전시하는 <먼슬리 프로젝트>로 다양한 개념미술을 발표했다. 이후 매체의 경계를 넘나드는 실험을 지속하며 인간과 예술, 사회에 관한 사유를 작품으로 풀어내고 있다.`,
...
2009.11-2010.04 Workshop 'Art, Architecture with Nature' - Jean Louis`,
  ...
  변경희: {
    ...
    profile: `변경희는 점을 이용한 입체적 표현으로 존재와 관계의 본질을 탐구하는 작가다. 2025년 개인전 《●에서 점으로》를 포함해 총 12회의 개인전을 열었고, 대한민국 미술대전을 비롯한 다수의 공모전에서 수상했다. 40회 이상의 단체전과 예술 프로젝트에 참여하며 활발한 전시 활동을 이어가고 있다. 작품은 홍콩, 국내 기업 및 개인 컬렉터들에게 소장되었으며, 현재 홍익대학교 미술대학원을 휴학하고 작업에 전념하고 있다. 점이라는 최소 단위로 생명성과 시간, 관계에 대한 시각적 언어를 구축해오고 있다.`,
    history: ``,
...
and others`,
  ...
  신예리: {
    name_en: 'Shin Yeri',
    profile: `신예리(호 담몽淡夢)는 한국 전통 화각공예와 민화의 결을 현대 시각언어로 잇는 작가다. 경원대학교(현 가천대) 섬유미술과를 졸업하고 경기무형문화재 화각장 한춘섭화각공예 공방에서 수석디자이너로 10년 근무한 뒤, 현재 민화공예공방 '담몽'을 운영하고 있다. 대한민국 국가미술특별초대전 초대작가, SNAF 성남아트페어 작가전, 목원회 단체전 등에 참여하며 전통 공예의 정밀함과 민화의 자유로운 도상을 회화 작업에 결합해 왔다.`,
...
2023.8-Present Chaekkiraut, Culture News, MHN Sports 'Picture Books Read by Cheon Jisu' Reviews`,
  ...
  하선영: {
    name_en: 'Ha Sunyoung',
    profile: `하선영은 홍익대학교에서 회화를 전공한 후 프랑스 아를국립사진학교에서 사진을 전공하였다. 나무의 초상화 작업과, 이후 팬데믹 시대의 힘겨운 사람들에게 아름다운 세계의 자연을 소재로 한 작품으로 우리에게 위안을 주는 작업을 계속하고 있다.`,
    history: ``,
...
Ph.D., Painting, Graduate School, Department of Fine Arts, Hongik University`,
  ...
  김유진: {
    name_en: 'Kim Yujin',
    profile: `'폭발의 다음' 시리즈 등을 통해 감정이 담긴 풍경과 관계 속의 외로움을 주제로 작업한다. 오픈갤러리 등 다양한 플랫폼에서 활동하고 있다.`,
    history: `오픈갤러리 등록 작가`,
...
2001 Study on Multi-layered Visual Experience Expression Using Plant Subjects`,
  ...
  이동구: {
    name_en: 'Lee Donggu',
    profile: `서울산업대(현 서울과학기술대) 도예과를 졸업했다. 다수의 공예대전 수상 경력을 가지고 있으며, '이동구 도예공방'을 운영하며 활발한 작품 활동과 소통을 이어가고 있다.`,
...
Major collections: National Museum of Modern and Contemporary Art (MMCA), Lee Young Contemporary Art Museum, Gallery Hyundai`,
  ...
  박영선: {
    ...
    profile: `박영선은 중국 루쉰 미술대학에서 수학한 판화가이자 화가로, 현재 인도 오로빌에 거주하며 작업하고 있다. 동아대학교 미술대학에서 미술을 전공한 이후, 중국 현대 판화 교육의 중심지인 루쉰 미술대학에서 판화 기반의 회화와 조형 언어를 체계적으로 익혔다. 중국 유학 시기부터 판화의 선과 면, 반복과 축적의 방식을 중심으로 작업을 이어온 그는, 이후 인도 오로빌에 정착하며 작업의 환경과 범위를 확장해왔다. 오로빌은 국적과 종교, 이념을 넘어선 국제 공동체로, 박영선은 이곳에서의 삶과 예술 실천을 통해 공동체, 노동, 자연, 인간의 존엄이라는 주제를 지속적으로 탐구해왔다. 출판으로 《까이비간》(산지니, 2007)이 있다.`,
    history: ``,
