...
MMCA Art Bank, Yangpyeong Museum of Art, Gwangju Museum of Art, Samtan Art Mine`,
  },
  김동석: {
    name_en: 'Kim Dongseok',
    profile: `김동석은 '길'을 일관된 화두로 삼아 회화 작업을 이어 온 서양화가다. 추계예술대학교 서양화과를 졸업하고 동국대학교 교육대학원에서 미술교육을 전공했으며, 31회의 개인전과 41회의 국내외 아트페어, 610여 회의 단체전에 참가했다. 작품집 《A Collection of Kim Dong Seok Paintings》(2019)을 비롯해 〈THE PATH〉 등 '길'을 주제로 한 화집을 출간했고, 국립현대미술관 미술은행, 김환기미술관, 전남도립미술관, 양평군립미술관, SK텔레콤 본사, 프랑스 대통령궁 등에 작품이 소장되어 있다.`,
    profile_en: `Kim Dongseok is a Western-style painter who has explored 'the path' as a consistent visual theme throughout his career. After graduating from the Department of Western Painting at Chugye University for the Arts and completing an M.Ed. in Art Education at Dongguk University, he has held 31 solo exhibitions, participated in 41 domestic and international art fairs, and shown in over 610 group exhibitions. He has published several monographs centered on 'the path,' including A Collection of Kim Dong Seok Paintings (2019) and THE PATH. His works are held in MMCA Art Bank, the Whanki Museum, Jeonnam Museum of Art, Yangpyeong Museum of Art, SK Telecom headquarters, and the Presidential Palace of France.`,
    ...
    history_en: `* B.F.A., Department of Western Painting, Chugye University for the Arts
...
* Current: Full-time artist, Member of ADAGP (International Copyright Society), Korean Fine Arts Association, Songpa Artists Association, Nurimuri`,
  },
  김상구: {
    name_en: 'Kim Sanggu',
    profile: `김상구는 1945년 서울에서 태어나 홍대 서양화과와 동대학원을 졸업하였다. 현대 산업사회의 기계화 시대에 역행하는 듯한 목판화와 철저한 수공 공정을 고수하는 보기 드문 작가다. 목각예술은 현란한 세련미 대신 우직함과 단순함을 특징으로 하는 동양적 장인정신과 서민적 속성에 뿌리를 둔다.\n이런 점에서 그의 목판화 작업은 가장 인간적인 작업 영역이며, 우리 사회에 인간미를 더해주는 시정과 같은 것으로 이해된다.\n그의 목판화 세계는 "화려한 것보다는 투박한 것, 복잡한 것보다는 단순한 가운데 스며드는 토담과 같은 것, 입체적 표현보다는 평면적인 것, 흑백의 대비, 가득 차 있는 것보다는 여백의 미"로 함축할 수 있다.\n70년대 후반 이래 발표 활동을 이어온 화가의 근작은 다색판화로 엮인다. 세심한 작업이 요구되는 다색판화로 표현 영역을 넓히면서도 꾸준하고 깊이 있는 작품을 추구한다.`,
...
1964, 3rd New Artist Award Exhibition Encouragement Prize`,
  ...
  김영서: {
    ...
    history_en: `M.A., Department of Oriental Painting, Graduate School, Hongik University
...
<In Contemplation, Each Has Their Own Sound>, A-Lounge, Seoul`,
  ...
  김우주: {
    name_en: 'Kim Wooju',
    profile: `김우주는 들꽃의 생멸과 풍경을 회화로 옮겨 온 작가다. 홍익대학교 일반대학원 회화과 석사를 졸업하고 박사과정을 수료했으며, 2023년 홍익대학교 현대미술관에서 개인전 〈Wildflower season1〉을, 2016년 PiaLuxART갤러리에서 〈Pictorial impulse〉를 열었다. 한국은행 신진 작가전, 서울시 청년작가 신예발굴 프로젝트 〈비상〉, 탑골미술관 〈도약의 단초〉 등에 초청되었다.`,
    profile_en: `Kim Wooju is a painter who translates the life cycles and landscapes of wildflowers into painterly form. After completing her M.F.A. and Ph.D. coursework at the Department of Painting, Graduate School of Hongik University, she presented solo exhibitions 〈Wildflower Season 1〉 at the Hongik University Museum of Modern Art (2023) and 〈Pictorial Impulse〉 at PiaLuxART Gallery (2016). Her work has been featured in the Bank of Korea Emerging Artist Exhibition, the Seoul Young Artist Discovery Project 'Bisang,' and 'Stepping Stone for a Leap' at Tapgol Museum of Art.`,
    ...
    history_en: `2013 M.F.A., Department of Painting, Graduate School, Hongik University
...
2014 Log Out, Litmus Gallery, Ansan, Korea`,
  ...
  김종환: {
    ...
    profile_en: `Kim Jonghwan majored in printmaking at university and currently runs 'Panhwabang,' a printmaking studio. He is an active member of the Korean Contemporary Printmakers Association and the Hongik Printmakers Association. His illustrated books include Half-and-Half, Dokkaebi Wrestling Festival, Hong Gildong, Han Feizi, The +-x÷ Magic Show, Dreams of Joseon Captured in Hanyang, and The Golden Dragon and the Rainbow, and he has also created illustrations for various monthly magazines.`,
    history_en: `Current: Representative of printmaking studio 'Panhwabang' / Member, Korean Contemporary Printmakers Association / Member, Hongik Printmakers Association
...
Ansan Foreign Workers Support Center`,
  ...
  김주호: {
    name_en: 'Kim Juho',
    profile: `김주호는 서울대학교 미술대학 조소과와 동 대학원을 졸업하고, <사람사이>(관훈갤러리, 2012), <생생풍경>(가회동 60, 2012) 개인전과 다수의 기획전에 참여해 왔다. 국립현대미술관, 대전시립미술관, 소마미술관 등에 작품이 소장되어 있다. 사람과 일상의 풍경을 작가 특유의 사색과 여유로 재해석하며 입체와 평면 작업을 일관되게 이어왔다. 일상에서 시작된 작가의 사색적 자세는 우리 주변의 다양한 이야기를 이끌어내고 공감과 소통을 만든다.\n작품 <조오타!>는 세상을 보는 호기심을, <세상을 보는 창>의 돋보기 형상은 대상을 투시하고 관계를 명확하게 보고자 하는 시선을 의미한다. 이런 독특한 조형적 인물 묘사는 돌고 도는 사람으로 연결되어 우리 삶의 인간관계를 말하는 듯하다.`,
...
2013 Incheon Art Platform Residency Program 4th Cohort Resident Artist, Incheon`,
  ...
  김주희: {
    name_en: 'Kim Juhee',
    profile: `이미지 오버랩 작가 김주희 입니다 저는 잊지못할 추억, 기억의 순간들을 오버랩합니다. 반복적인 중첩과 전혀 다른 공간의 오버랩을 통해 기억을 되새기고 또는 합성합니다. "그리다" 라는 말은 "그리워하다"에서 파생되었듯이 그리운 것들을 사랑하고 보고싶은 것들을 보고 또 보고 사진으로 찍어 겹쳐 작업합니다 그림속 이미지는 계속 중첩하여  파괴되는 것이 아니라 더 선명하게 되살아납니다 이는 현대인들의 욕망 가지고 싶은 것들 사라져버리는 것에 대한 아쉬움 을 포함하고  있습니다`,
    ...
    profile_en: `Kim Juhee is an image overlap artist who overlaps unforgettable memories and momentary recollections. Through repetitive layering and the overlapping of entirely different spaces, she revisits and synthesizes memories. Just as the Korean word for 'to draw' (grida) derives from 'to miss' (griwohada), she photographs and layers the things she loves and longs to see, again and again. The images within her paintings are not destroyed through continuous layering but instead revive more vividly. This reflects the desires of modern people, the things they want to possess, and the wistfulness over things that vanish.`,
    history_en: `B.F.A., Department of Western Painting, Sungshin Women's University
...
Naver Project Flower CreaterDay4 Selected Artist`,
  ...
  김준권: {
    name_en: 'Kim Joonkwon',
    profile: `김준권은 1956년 전남 영암에서 태어나 1982년 홍익대학교 서양화과를 졸업했다. 1994년부터 1997년까지 중국 魯迅미술대학 목판화 연구원으로 활동했으며, 1997년에 한국 목판문화 연구소를 개설해 목판화 작업을 이어간다.\n목판화 작업으로 민중미술운동에 참여한 작가이기도 하다. 1980년대 미술교육운동에 몰두하던 시기에는 리놀륨 판화(Linoleum cut) 작업으로 민중목판화의 양식적 특성을 보여주었다. 대동세상을 꿈꾸는 농민운동 지도자 전봉준(全琫準)을 소재로 삼고 전통회화 양식, 특히 불화 중 ‘수월관음도(水月觀音圖)’의 양식을 참고해 제작하며 명확하고 정직한 구성으로 전통에 대한 관심을 드러냈다.\n김준권의 수성 다색목판화는 한국 현대 산수화의 방향을 제시할 만큼 독보적 위치를 차지한다. 조선후기 진경산수화의 겸재 정선이나 단원 김홍도를 계승한 조형미를 떠올리게 한다. 현실의식을 바탕으로 한 국토 사랑, 부지런한 발품, 생거진천(生居鎭川)의 땅에서 받는 에너지, 다년간 축적된 판화기술과 예술적 완숙, 한 작품에 대여섯 판 이상 파고 찍는 강도 높은 노동을 감내하는 장인정신이 돋보인다.`,
...
National Art Museum of China, China Printmaking Museum, Lu Xun Academy of Fine Arts Museum, etc.`,
  ...
  김호성: {
    name_en: 'Kim Hoseong',
    profile: `작가소개\n경희대학교 사학과를 졸업하고 중앙대학교 사진학과를 나와 현대미술가로 활동한다. 초기에는 사진과 영상을 기반으로 현대인의 욕망과 방황을 다룬 작업을 주로 선보였다. 2018-2019년에는 24시간 출입 가능한 무인 갤러리를 운영하며 매달 전시하는 <먼슬리 프로젝트>로 다양한 개념미술을 발표했다. 이후 매체의 경계를 넘나드는 실험을 지속하며 인간과 예술, 사회에 관한 사유를 작품으로 풀어낸다.`,
...
2011 <New Generation Art Star Exhibition>, Hangaram Art Museum, Seoul Arts Center, Seoul, Korea`,
  },
  라인석: {
    name_en: 'Ra Inseok',
...
2019 <On Photography>, Nunbit Publishing, pp. 37-43`,
  ...
  류연복: {
    name_en: 'Ryu Yeonbok',
    profile: `류연복은 경기도 가평에서 태어나 서울에서 학업을 하다가 1977년 홍익대 미대에 입학하면서 본격적으로 민중미술의 세계에 뛰어든 작가다. ‘아름다움은 많은 이들이 누릴 수 있어야 한다.’는 소박한 믿음은 그가 대학을 졸업하던 1984년 서울 미술공동체를 결성하고 벽화팀 ‘십장생’에서 벽화운동을 이끄는 원동력이 되었다. 1985년에는 미술장터 격인 ‘을축년 미술 대동잔치’를 열어 서민들도 단돈 5천원이면 미술작품을 살 수 있도록 했고, 1986년 경찰의 탄압으로 중단되었던 전시 《20대의 힘》에도 관여했다. 1989년에는 임수경의 방북에 앞서 미국으로 가서 북쪽에 보낼 걸개그림과 판화를 만들기도 하였다.\n목판화는 비교적 제작이 쉽고 거의 무제한으로 복제할 수 있는 매체다. 이런 특징은 민중이 미술을 바라보는 데 그치지 않고 직접 제작하는 것을 목표로 삼았던 민중미술 작가들에게 중요한 이점이었다. 소수의 부유층에게만 향유되던 기존 미술에 반대했던 흐름과도 맞닿아 있었다. 1980년대에는 민중운동의 여파로 판화 제작이 매우 보편화되었고, 특히 목판화는 전통과 연결된다는 점에서 더욱 환영받았다. 류연복은 목판화 특유의 거친 칼맛을 잘 살려내어 단순한 화면 구성 안에서 역동적인 인물과 배경의 조화를 표현하였다.`,
...
2009 Solo Exhibition, Jain Zeno Gallery`,
  ...
  리호: {
    ...
    history_en: `2022 Ph.D. candidate, Department of Oriental Painting, Graduate School, Hongik University
...
Solo Exhibitions
2022 <Invisible Project>, Sai Art Document, Seoul`,
  },
  민정See: {
    name_en: 'MinjeongSee',
    profile: `민정See는 '플라스틱'이라는 물성을 통해 현대 사회의 표면과 위장을 비판적으로 탐구해 온 판화·드로잉 작가다. 홍익대학교 판화과를 졸업하고 시카고 SAIC(School of the Art Institute of Chicago)에서 Printmedia 석사를 받았다. 2014년 갤러리AG 〈Plastic Society I〉, 2016년 영은미술관 〈Plastic Promise〉, 2024년 서리풀휴갤러리 〈빛 이후 표상〉 등 다수의 개인전을 열었으며 2025년 화랑미술제 Zoom-In 작가로 선정되었다. 작품은 소마미술관 드로잉센터, 영은미술관, 벨기에 Frans Masereel Centrum, 미국 Purdue University, John Flaxman Artist Book Collection 등에 소장되어 있다.`,
    profile_en: `MinjeongSee is a printmaker and drawing artist who critically explores the surface and disguise of contemporary society through the materiality of 'plastic.' She graduated from the Department of Printmaking at Hongik University and received her M.F.A. in Printmedia from the School of the Art Institute of Chicago (SAIC). Her many solo exhibitions include Plastic Society I at Gallery AG (2014), Plastic Promise at Youngeun Museum (2016), and Representation After Light at Seoripul Hyu Gallery (2024). She was selected as a Zoom-In artist at the 2025 Korea Galleries Art Fair. Her works are held at the SOMA Museum Drawing Center, Youngeun Museum, Frans Masereel Centrum (Belgium), Purdue University (USA), and the John Flaxman Artist Book Collection.`,
...
2011 Community Show, Andover Newton Theological School, Boston`,
  ...
  박성완: {
    ...
    profile_en: `Park Seongwan depicts everyday landscapes with bold, rough brushstrokes and vivid colors. He graduated from Chonnam National University's College of Arts, Department of Fine Arts, and completed his M.A. in Fine Arts (Western Painting) at the same university's graduate school.`,
    history_en: `Education
...
2012 Eodeung Art Festival Grand Prize`,
  ...
  박소형: {
    name_en: 'Park Sohyung',
    profile: `박소형 작가는 서울, 보스턴, 뉴욕에서 활동하는 조형예술가다. 보스턴대학에서 조형예술 석사(BU MFA Sculpture ’23)를 마치고, 뉴욕 스쿨오브비주얼아트(SVA BFA ’21)에서 순수예술 학사를 전공하였다. 조각, 설치미술, 비디오 아트 등 다양한 매체로 작업하며, AI를 결합한 미디어 작업과 식물·버섯포자 등을 다루는 생태예술 장르를 넘나들며 독특한 예술세계를 구현한다. 보스턴과 뉴욕, 서울을 중심으로 활동하며, 뉴잉글랜드 스컵쳐 어소시에이션(NESA), 보스턴 기후위기 아티스트 그룹 I3C(Inspiring Climate Change), 한국여성 아티스트 그룹 그린 레시피 랩의 멤버로도 참여한다. 2022년 Emerson College Media Art Gallery에서 주최한 What's next: Perspective Micro and Macro 전시에 선정되어 보스턴에서 활동하는 신진 작가로 이름을 올렸다.`,
...
2009.11-2010.04 Workshop 'Art, Architecture with Nature' - Jean Louis`,
  ...
  백금아: {
    name_en: 'Baek Geuma',
    profile: `백금아는 한국수채화협회에서 활동해 온 수채화 작가다. 노리갤러리 3인전(2014), 한국수채화협회전(2010~2018), 제주신화전(2023~25), 예술인협동조합전(2024~25) 등 다수의 단체전과 기획전에 참여하며 수채라는 매체로 한국의 자연·신화·일상을 기록해 왔다.`,
    profile_en: `Baek Geuma is a watercolor painter active within the Korea Watercolor Association. She has participated in numerous group and curated exhibitions, including a 3-person exhibition at Nori Gallery (2014), the Korea Watercolor Association Exhibition (2010-2018), the Jeju Mythology Exhibition (2023-25), and the Artists' Cooperative Exhibition (2024-25), recording Korean nature, mythology, and everyday life through the medium of watercolor.`,
    history: `노리갤러리 3인전(2014), 한국수채화협회전(2010~2018), 백금아 개인전(), 제주신화전(2023~25), 예술인협동조합전(2024~25) 외 다수`,

    history_en: `Nori Gallery 3-Person Exhibition (2014), Korea Watercolor Association Exhibition (2010-2018), Baek Geum-a Solo Exhibition, Jeju Mythology Exhibition (2023-25), Artists' Cooperative Exhibition (2024-25) and others`,
  },
  변경희: {
    name_en: 'Byun Kyunghee',
    profile: `변경희는 점을 이용한 입체적 표현으로 존재와 관계의 본질을 탐구하는 작가다. 2025년 개인전 《●에서 점으로》를 포함해 총 12회의 개인전을 열었고, 대한민국 미술대전을 비롯한 다수의 공모전에서 수상했다. 40회 이상의 단체전과 예술 프로젝트에 참여하며 활발한 전시 활동을 이어간다. 작품은 홍콩, 국내 기업 및 개인 컬렉터들이 소장하고 있으며, 현재 홍익대학교 미술대학원을 휴학하고 작업에 전념한다. 점이라는 최소 단위로 생명성과 시간, 관계에 대한 시각적 언어를 구축해 왔다.`,
    history: ``,

    profile_en: `Byun Kyunghee is an artist who explores the essence of existence and relationships through three-dimensional expression using dots. She has held a total of 12 solo exhibitions including Dots to Points (2025), and has been awarded at numerous competitions including the Grand Art Exhibition of Korea. She has participated in over 40 group exhibitions and art projects, maintaining an active exhibition practice. Her works are collected by clients in Hong Kong, Korean corporations, and private collectors. Currently on leave from the Graduate School of Fine Arts at Hongik University to devote herself to her work, she continues to build a visual language addressing vitality, time, and relationships through the minimal unit of the dot.`,
  },
  서금앵: {
    name_en: 'Seo Geumaeng',
    profile: `서금앵은 일상 공간에 깃든 기운과 기억의 결을 회화로 옮겨 온 작가다. 숙명여자대학교 회화과를 졸업하고 같은 대학원 조형예술학과에서 석사를 마쳤다. 〈Rooms〉(2008 이형아트센터)부터 〈공간의 기운〉(2023 이랜드 기획전), 〈기억의 밀도〉(2025 아트스페이스J 초대전), 〈서금앵전〉(2025 갤러리일호) 등 다수의 개인전을 열었으며, ASYAAF, 브리즈 아트페어, 광화문 국제 아트 페스티벌, K-Auction 프리미엄 경매 프리뷰전 등에 참여했다. 작품은 국립현대미술관 미술은행, ㈜이랜드 문화재단 등에 소장되어 있다.`,
    profile_en: `Seo Geumaeng is a painter who translates the energies and memories embedded in everyday spaces into painterly form. After graduating from the Department of Painting at Sookmyung Women's University, she completed her M.F.A. in Formative Arts at the same university's graduate school. She has held numerous solo exhibitions, from 〈Rooms〉 (Leehyung Art Center, 2008) to 〈Energy of Space〉 (E-Land Curated, 2023), 〈Density of Memory〉 (Art Space J, 2025), and 〈Seo Geum-aeng Exhibition〉 (Gallery Ilho, 2025). She has participated in ASYAAF, Breeze Art Fair, Gwanghwamun International Art Festival, and the K-Auction Premium Auction Preview. Her works are held in the collections of MMCA Art Bank and the E-Land Cultural Foundation.`,
...
A-Company, APC Works <Monthly Hanok> and numerous private collections`,
  ...
  손은영: {
    name_en: 'Son Eunyoung',
    profile: `손은영은 '집'이라는 모티프로 도시와 기억의 풍경을 사진에 담아 온 작가다. 이화여자대학교 미술대학 서양화과를 졸업하고 홍익대학교 산업미술대학원에서 사진디자인 석사를 마쳤다. 2024년 갤러리 브레송 〈그 집에 산다〉, 예술곳간 〈기억의 집〉 등 13회의 개인전을 열었으며, 2020년 사진집 《밤의 집(The Houses at Night)》(눈빛)을 출간하고 2021년 개정판을 나미브에서 펴냈다. 2021년 제2회 FNK Photography Award 예술사진부문에 당선되었고, 2022년 BELT 판화·사진 공모 사진부문 작가로 선정되었다.`,
    profile_en: `Son Eunyoung is a photographer who captures urban and memorial landscapes through the recurring motif of 'house.' She graduated from the Department of Western Painting at Ewha Womans University and completed her M.A. in Photography Design at the Graduate School of Industrial Art at Hongik University. She has held 13 solo exhibitions, including 〈Living in That House〉 at Gallery Bresson and 〈House of Memory〉 at Yeosulgotgan in 2024. Her photobook The Houses at Night was published by Nunbit (2020) and reissued by Namib (2021). She won the 2nd FNK Photography Award (Art Photography category) in 2021 and was selected for the BELT 2022 Print/Photography Competition (Photography category).`,
...
2018 Seoul City Hall Sky Plaza Gallery Artist Competition Winner`,
  ...
  손장섭: {
    name_en: 'Son Jangsub',
    profile: `손장섭(孫壯燮, 1941- 2021)은 1980년대 민중 미술을 이끈 단체인 '현실과 발언'의 창립 회원이었다. 그는 역사와 민중의 삶에 대한 깊은 애정과 현실 인식을 바탕으로 역사화, 풍경화 연작을 제작하면서 역사와 자연의 시간이 결합된 자신만의 독특한 풍경 회화를 구축했다.

손장섭의 1980년대 작품은 치열한 역사의식과 현실의 모순에 대한 저항 의식을 드러내는 전형적인 민중 미술 경향을 띤다. 그는 1990년대 말까지 역사화 연작과 함께 한국의 자연 풍경, 서민들의 모습을 담은 회화 작업을 꾸준히 지속했으며, 2000년대에 들어서는 '나무' 연작과 '풍경화' 연작을 작업하며 오랜 세월 한자리에서 버티며 역사의 현장을 고스란히 목격한 자연을 주인공으로 삼았다.`,
    history: ``,

    profile_en: `Son Jangsub (1941–2021) was a founding member of 'Reality and Utterance,' a group that spearheaded the Minjung (People's) Art movement in the 1980s. Based on a deep affection for history and the lives of ordinary people, combined with an awareness of social reality, he produced series of historical paintings and landscape paintings, constructing his own distinctive landscape painting that merged historical and natural temporalities. His 1980s works exhibit the typical characteristics of Minjung Art, revealing an intense historical consciousness and a spirit of resistance against social contradictions. Through the late 1990s, he continued his historical painting series alongside paintings depicting Korean natural landscapes and the lives of common people. In the 2000s, he embarked on his 'Tree' series and 'Landscape' series, making nature—which has endured in one place through long ages, silently witnessing the sites of history—the protagonist of his work.`,
  },
  송광연: {
    name_en: 'Song Gwangyeon',
    profile: `송광연은 한국적 도상과 팝아트의 어법을 결합한 〈나비의 꿈〉 시리즈로 알려진 회화 작가다. 영남대학교 서양화전공으로 석사를 마치고 갤러리 썬(서울), BNK경남은행 본점 아트갤러리(창원), 울주문화예술회관 등에서 24회의 개인전을 열었다. 2017년 런던 사치 갤러리 START Art Fair 솔로 부스 작가로 선정되었으며, 2016년 주미 한국대사관 한국문화원(워싱턴DC) 초대전, 2017년 주상하이 한국문화원 초대전 등 국외 전시에도 활발히 참여했다. 작품은 울산시립미술관, 한국민속촌 미술관 등에 소장되어 있다.`,
    profile_en: `Song Gwangyeon is a painter known for the 〈Dream of a Butterfly〉 series, which combines Korean iconography with the visual language of Pop Art. After completing her M.A. in Western Painting at Yeungnam University, she has held 24 solo exhibitions at venues including Gallery Sun (Seoul), BNK Kyongnam Bank HQ Art Gallery (Changwon), and Ulju Culture & Arts Center. She was selected as a Solo Booth artist at the 2017 START Art Fair at Saatchi Gallery in London. Her international exhibitions include the 2016 invitational at the Korean Cultural Center in Washington D.C. and the 2017 invitational at the Korean Cultural Center in Shanghai. Her works are held in the collections of the Ulsan Museum of Art and the Korean Folk Village Museum.`,
    ...
    history_en: `M.A., Western Painting, Yeungnam University
...
Mokwonhoe Group Exhibition participant`,
  },
  신학철: {
    name_en: 'Shin Hakchul',
...
Awards
1982 JoongAng Art Competition Encouragement Prize`,
  },
  아트만두: {
    name_en: 'Artmandu',
    profile: `아트만두는 캐리커처와 시사만화의 칼끝을 회화의 영역으로 끌고 들어온 작가다. 홍익대학교 미술대학 판화과를 졸업하고 같은 대학원을 마쳤으며, 한길사 출간 《아트만두의 '목표는 방구防口'다》(2022), 붓과펜 출간 《아트만두의 '비틀뉴스'》(2025) 등 작품집을 펴냈다. 2019년 싱가포르 The Brandlaureate World Bestbrands Awards 퍼스널 아티스트 부문 수상, 2021년 SICAF 서울국제만화애니메이션페스티벌 코믹부문 공로상을 수상했다. 한국샐라티스트협회전, 생쥐스트르마르텔 국제시사만화살롱(프랑스), 도쿄 사이타마 국제풍자만화전 등 국내외 전시에 활발히 참여한다.`,
    profile_en: `Artmandu is an artist who brings the sharp edge of caricature and editorial cartooning into the realm of fine art. After graduating from the Department of Printmaking at the College of Fine Arts, Hongik University, and completing his M.F.A. at the same institution, he has published collections including Artmandu's 'The Goal Is Banggu (防口)' (Hangil Publishing, 2022) and Artmandu's 'Beetle News' (Brush & Pen, 2025). He received the Personal Artist award at The Brandlaureate World BestBrands Awards in Singapore (2019) and the Comic Category Achievement Award at SICAF (2021). His work has been featured in the Korean Caricaturist Association Exhibition, the Saint-Just-le-Martel International Editorial Cartoon Salon (France), and the International Satirical Cartoon Exhibition at Saitama Media Tower (Tokyo).`,
    ...
    history_en: `B.F.A. and M.F.A., Department of Printmaking, College of Fine Arts, Hongik University
...
2023 SOYCOPASS proprietary IP NFT development and release`,
  },
  안은경: {
    name_en: 'Ahn Eunkyung',
    profile: `안은경은 동양화의 어법으로 여행과 회복의 풍경을 기록해 온 작가다. 홍익대학교 미술대학 동양화과에서 박사를 받고 울산대학교 객원교수를 역임했으며, 가나아트스페이스(2017), 뉴욕 Caffebene Time Square·THE WHEEL HOUSE 초대전(2015~2016), 가기갤러리(2024), 갤러리 HOSI(동경) 등에서 〈The Journey to The Recovery〉, 〈Boundary 여행〉, 〈Only Dream-ing Traveler〉, 〈반추〉 등 다수의 개인전을 열었다. ARPNY(Artist Residency Program, 뉴욕) 레지던시에 참여했고, 작품은 울산문화예술회관, 울산대학교, 울주세계산악영화제 등에 소장되어 있다.`,
    profile_en: `Ahn Eunkyung is an artist who records landscapes of journey and recovery through the language of Oriental painting. After completing her Ph.D. at the Department of Oriental Painting, College of Fine Arts, Hongik University, she served as a visiting professor at the University of Ulsan. Her many solo exhibitions include 〈The Journey to The Recovery〉 at Gana Art Space (2017) and at Caffebene Time Square and THE WHEEL HOUSE in New York (2015–2016), 〈Boundary Travel〉 at Buk-gu Culture & Arts Center (2022), 〈Rumination〉 at Gagi Gallery (2024), and 〈Joy of Voyage〉 at Gallery HOSI in Tokyo. She participated in the ARPNY (Artist Residency Program) in New York, and her works are held in collections including the Ulsan Culture & Arts Center, the University of Ulsan, and the Ulju World Mountain Film Festival.`,
    ...
    history_en: `Ph.D., Department of Oriental Painting, College of Fine Arts, Hongik University
...
1998.10.8-10.20 "C'era una volta il nudo, e poi...", Famiglia Artistica Milanese, Milan, Italy; Gallery May, Seoul`,
  },
  이유지: {
    name_en: 'Lee Yuji',
    profile: `이유지는 깊은 내면의 풍경과 염원의 정서를 회화로 풀어내 온 작가다. 수원대학교 서양화과를 졸업하고 국민대학교 대학원에서 석사를 마쳤으며, 〈바램이 머물다 다시 일어서는 곳〉(2025 아트보다갤러리), 〈카르마다이스〉(2025 강화 전등사 무설전), 〈염원의 파티〉(2024 더 스퀘어즈 갤러리), 〈심연의 풍경〉(2017 사이아트도큐먼트) 등 다수의 개인전을 열었다. 2024년 겸재 정선 미술관 〈내일의 작가〉 우수상을 수상했고, 작품은 겸재 정선 미술관, 서울 문화 본부 박물관과, 하나은행 아트뱅크 등에 소장되어 있다.`,
    profile_en: `Lee Yuji is a painter who unfolds the landscapes of deep inner consciousness and the sentiments of longing through painting. After graduating from the Department of Western Painting at Suwon University, she completed her M.A. at Kookmin University. Her many solo exhibitions include 〈Where Wishes Linger and Rise Again〉 at Art Boda Gallery (2025), 〈Karma Dice〉 at Seoun Gallery in Ganghwa's Jeondeungsa Temple (2025), 〈Party of Wishes〉 at The Squares Gallery (2024), and 〈Landscape of the Abyss〉 at Sai Art Document (2017). She received the Excellence Award at the 〈Artist of Tomorrow〉 competition by the Gyeomjae Jeong Seon Museum of Art (2024). Her works are held in the collections of the Gyeomjae Jeong Seon Museum of Art, the Seoul Culture Headquarters Museum, and the Hana Bank Art Bank.`,
...
Publications: <Paintings with Stories>, <Room of Paintings>, <Northern European Museum Tour>, <Minimum Art 100 for Today's Adults> and others`,
  },
  이익태: {
    name_en: 'Lee Iktae',
...
Chronicles of Light / Democratization Memorial Hall`,
  ...
  이재정: {
    name_en: 'Lee Jaejeong',
    profile: `이재정은 사회와 풍경, 신화와 일상 사이를 사진으로 횡단해 온 작가다. 〈제주신화전〉(2016), 〈박근혜 하야전〉(2017), 〈이중초상화 연작전〉(2019), 〈마을극장 DMZ레지던시전〉(2020), 〈새들은 펜데믹을 두려워 하지 않는다〉(2022), 〈화산도〉(2023), 〈칠실파려안〉(2024), 〈천 개의 카메라〉(2025) 등 다수의 개인전과 기획전, 대구사진비엔날레·수원국제사진축제·화산섬국제사진제 같은 사진 페스티벌에 활발히 참여하며 한국 사회의 결을 사진으로 기록해 왔다.`,
    profile_en: `Lee Jaejeong is a photographer who traverses society and landscape, myth and everyday life. He has held numerous solo and curated exhibitions—including 〈Jeju Mythology Exhibition〉 (2016), 〈Park Geun-hye Impeachment Exhibition〉 (2017), 〈Double Portrait Series Exhibition〉 (2019), 〈Village Theater DMZ Residency Exhibition〉 (2020), 〈Birds Don't Fear the Pandemic〉 (2022), 〈Volcanic Island〉 (2023), 〈Chilsilparyeoan〉 (2024), and 〈A Thousand Cameras〉 (2025)—and has actively participated in photography festivals such as the Daegu Photo Biennale, Suwon International Photo Festival, and Volcanic Island International Photo Festival, recording the textures of Korean society through his lens.`,
    ...
    history_en: `Jeju Mythology Exhibition (2016), Park Geun-hye Impeachment Exhibition (2017), Daegu Photo Biennale (Fringe), Suwon International Photo Festival, Jeju Mythology Korea-Japan Exhibition (2017), Volcanic Island International Photo Festival, Republic of Korea International Photo Festival, Double Portrait Series Exhibition (2019), Lost Garden Exhibition, Village Theater DMZ Residency Exhibition (2020), Wise Home Life Exhibition (2021), Birds Don't Fear the Pandemic Exhibition (2022), Volcanic Island Exhibition (2023), Chilsilparyeoan Exhibition (2024), A Thousand Cameras (2025), and numerous solo exhibitions, group exhibitions, and art fairs`,
  },
  이지은: {
    name_en: 'Lee Jieun',
    profile: `이지은은 입체와 회화의 경계를 가로지르며 추상적 형태와 색의 가능성을 탐구해 온 작가다. 1984년생으로 국민대학교 입체미술전공 학·석사를 마친 뒤 독일 브레멘 국립예술대학교에서 9학기를 수학하고, 2017년 뒤셀도르프 쿤스트아카데미에서 디플롬과 마이스터슐러(프란카 훼렌쉐메이어 교수반)를 마쳤다. 〈Hollowed Colors〉(2025 아트스페이스 엣), 〈structure〉(2023 크비텐바움 갤러리, 뮌헨), 〈reversed〉(2019 비젠박흐 갤러리, 쾰른) 등 한국과 독일을 오가며 다수의 개인전을 열었으며, 2011년 브레멘 국립예술대학교 Hochschulpreis 대상, 2015년 DAAD Matching Fund 장학금을 수상했다.`,
    profile_en: `Lee Jieun is an artist who traverses the boundary between sculpture and painting, exploring the possibilities of abstract form and color. Born in 1984, she completed her B.F.A. and M.F.A. in Sculpture at Kookmin University before studying for nine semesters at the Hochschule für Künste Bremen and earning her Diploma and Meisterschüler at Kunstakademie Düsseldorf (Class of Prof. Franka Hörnschemeyer) in 2017. She has held numerous solo exhibitions across Korea and Germany, including 〈Hollowed Colors〉 (Art Space Et, 2025), 〈structure〉 (Quittenbaum Galerie, Munich, 2023), and 〈reversed〉 (Biesenbach Galerie, Cologne, 2019). She received the Hochschulpreis Grand Prize at Hochschule für Künste Bremen (2011) and the DAAD Matching Fund Scholarship (2015).`,
...
2011 Grand Prize, Hochschulpreis, Hochschule für Künste Bremen, Germany`,
  },
  이철수: {
    name_en: 'Lee Cheolsu',
...
Goseong DMZ Museum (2018)`,
  ...
  이혜선: {
    name_en: 'Lee Hyeseon',
    profile: `이혜선은 제주의 푸른 바다를 모티프로, 드리핑(dripping)과 액션 페인팅의 즉흥적 운동성으로 〈Glory_moment#+〉 연작을 이어 온 추상 회화 작가다. '당신의 존엄한 삶을 대도약하라'는 문장을 화두 삼아, 몸의 운동성과 즉흥적 구성으로 도약과 희망의 정서를 화면에 새긴다. 입체적 질감과 파도의 균열을 통해 다양한 블루의 심연을 표현한다.`,
    profile_en: `Lee Hyeseon is an abstract painter who continues her 〈Glory_moment#+〉 series, drawing inspiration from Jeju's blue sea and using the spontaneous movement of dripping and action painting techniques. Built on the phrase 'leap into your dignified life,' her practice etches sentiments of leaping and hope onto canvas through bodily movement and improvisational composition. With three-dimensional textures and the fissures of waves, she expresses the varied depths of blue.`,
    history: ``,
  },
  이호철: {
    name_en: 'Lee Hochul',
  ...
  이홍원: {
    ...
    history_en: `1974-1980 College of Arts, Dongguk University
...
2011 BEYOND, Ryugaheon`,
  ...
  정미정: {
    ...
    history_en: `M.A., Fine Art, Chelsea College of Arts, London, UK
...
Fill Gallery, Gallery Jeong, Seum Art Space, Sophis Gallery`,
  ...
  정서온: {
    name_en: 'Jeong Seoon',
    profile: `정서온 작가(b.1984)는 대구대학교 및 동 대학원에서 미술디자인학과 회화를 전공하며 2009년 B.F.A. 학위를 취득한 이후, 현대미술 분야에서 활발히 활동해 온 작가다. 그는 대구를 기반으로 활동을 시작했지만, 국내외에서 폭넓게 작품 세계를 확장하며 국제적인 경험을 쌓아왔다. 2009년 영천창작스튜디오에서 첫 창작 활동을 시작한 그는, 2013년부터 2017년, 그리고 2020년에는 베를린에 거주하며 다양한 전시와 프로젝트에 참여했다. 2023년에는 대구 앞산 갤러리와 2024년에는 문화예술팩토리와 포항에서 개인전을 개최했으며 새로운 작품을 선보이는 등 꾸준히 창작과 전시 활동을 이어간다.\n정서온의 작품 세계는 ‘집’이라는 형상을 매개로 공간, 사물, 인간과 세계의 관계를 탐구하는 데 중심을 둔다. 그의 작업은 물리적 공간을 넘어 정신적 공간까지 다루며, 깊이 있는 사유와 독창적인 시각으로 관람객에게 존재와 관계에 대한 새로운 통찰을 제시한다.`,
...
2007-2014 Numerous group exhibitions and invitational exhibitions`,
  ...
  조신욱: {
    ...
    history_en: `2018 B.F.A., Department of Painting, Incheon Catholic University
...
and numerous others`,
  ...
  주재환: {
    name_en: 'Joo Jaehwan',
    profile: `주재환은 1940년 서울에서 태어났다. 중학교 시절, 반 고흐(Van Gogh)에 반해 미술가로서 꿈을 키웠다. 1960년 홍익대학교 미술대학에 입학했다가 한 학기 만에 중퇴했다. 학교 등록금으로 더 많은 재료를 구해 작업하고자 하는 의지가 그 이유였다. 주재환은 이후 20년간 미술과 아무 상관없는 다양한 직종을 전전하며 생계를 위한 시절을 보냈다. 20대에는 피아노 외판원, 창경궁 아이스크림 장사꾼, 파출소 방범대원 등으로 일했다. 30대에 들어 민속학자 심우성을 도와 잡지사, 출판사 일을 시작했다. 독서생활, 삼성출판사, 미술과 생활, 출판문화연구소, 미진사를 거쳤다. 이 과정에서 한국의 사회 현실을 몸으로 익힐 수 있었다. 덧붙여, 수더분하면서도 재치 있는 표정과 태도, 남을 널리 포용할 줄 아는 도량 역시 선물로 얻었다.\n주재환은 작가 활동을 하지 않는 기간에도 문화예술계 인사들과 어울림을 멈추지 않았다. 대학로 학림다방, 르네상스, 명동 은성, 송석 등 다방과 술집이 주로 모이는 장소였다. 대학교 선후배부터 미술평론가 이일, 시인 김수영 등을 만났다. 이 영향으로 창작욕이 생겨 1970년대 초반에는 김인환이 하던 광화문 술집 쪽샘에서 작은 개인전을 열기도 했다.\n주재환은 1979년 '현실과 발언'의 결성 과정과 1980년 '현실과 발언' 창립전 출품을 계기로 미술계라 불리는 곳에 첫걸음을 내디뎠다. 이 시기 그의 작품은 주로 당시 역사적, 정치적 주제와 깊게 연관되어 있었다. 당시 그린 <몬드리안 호텔>(1980)과 <계단을 내려오는 봄비>(1980)는 지금껏 대표작으로 회자된다. '현실과 발언' 이후 주재환의 사회적 삶은 진보적 지식인, 작가, 활동가 등에 걸친 복잡한 것이었다. 쉽지 않았던 86년의 장준하 선생 새긴돌 건립일이나 90년의 4.19혁명 30주기 기념행사 준비 등이 그 예다. 이런 류의 재야 쪽 공공적 일에 그는 많은 애정과 시간을 쏟았다.\n주재환은 1990년대 들어 역사, 정치가 아닌 자본 구조에 대한 비판을 주제로 하는 작품을 발표한다. 이 무렵은 80년대적 민주화 운동의 가투식 분위기가 어느 정도 진정되고 사회 전반의 분위기가 많이 바뀌고 있던 때였다. 해외에서는 베를린 장벽이 무너졌고 국내에선 김영삼 대통령이 정권을 잡았다. 그의 90년대 작품은 변화한 사회를 80년대 작품과 다른 시각으로 포착, 비판한 것이다. <미제점 송가>, <짜장면 배달>, <쇼핑맨> 등이 90년대 대표작이다.\n주재환은 2000년대에 들어서 그 어느 때보다 활발한 활동을 보여준다. 그는 젊은이들이 그의 다양한 작업 방식에서 느끼는 해방감이 기회를 만들어주는 것 같다고 말한다. 2001년 아트선재센터 개인전 '이 유쾌한 씨를 보라', 2007 대안공간 사루비아 다방 개인전, 2003 제50회 베니스비엔날레 특별전 등에서 작품을 선보였으며 2001년 제10회 민족예술인상, 2002년 유네스코 프라이즈 특별상을 받았다.`,
...
2001 'RETURN', Deokwon Gallery, Seoul, Korea`,
  },
  최윤정: {
    name_en: 'Choi Yoonjung',
...
2020 Hyeonghyeongsaeksaek Culture & Arts Support Project Selected, Suwon Cultural Foundation`,
  ...
  최혜수: {
    name_en: 'Choi Hyesu',
    profile: `최혜수는 인간 존재와 삶의 의미에 대한 질문을 예술로 기록하는 시각 예술가이다. 그의 작업은 유한한 생을 관찰하고 재해석하는 과정에서 비롯되며, 반복되는 일상 속에 숨은 충만과 결핍, 연결과 단절의 순간을 드러낸다. 관객이 자신의 존재와 여정을 성찰하도록 이끌고, 각자의 삶이 지닌 고유한 소명과 의미에 대한 사유를 확장한다.`,
    ...
    profile_en: `Choi Hyesu is a visual artist who records questions about human existence and the meaning of life through art. Her work originates from observing and reinterpreting finite life, revealing moments of fullness and deficiency, connection and disconnection hidden within repetitive daily routines. Through this, she guides viewers to reflect on their own existence and journey, expanding contemplation on the unique calling and meaning inherent in each person's life.`,
    history_en: `Education
...
Dongwha Pharmaceutical`,
  ...
  '칡뫼 김구': {
    ...
    history_en: `2025 Wasteland: Field of Phantoms Exhibition (57th Gallery) / 2024 Wasteland: Field of Idols Exhibition (Namu Art) / 2023 Partisan of Trees Guerrilla Exhibition: Portrait of General Hong Beom-do (Namu Art) / 2023 Fukushima Josam Mosa Exhibition (Arte Sup) / 2023 70th Anniversary of Armistice Curated Exhibition: Beloved Faces (Imjingak) / 2023 SAF Artist Support Fund Exhibition (Indipress) / 2023 10.29 Itaewon Disaster Memorial Exhibition (Arte Sup) / 2022 'Looking' Solo Exhibition (Namu Art) / 2021 Kim Suyoung 100th Birthday Anniversary Exhibition (Le Franc) / 2020 'Sad' Solo Exhibition (Hwain Art) / 2019 Republic of Korea Prosecution Exhibition (Space Union) / 2018 Peace, Reunification, Wish DMZ International Invitational (Odusan Unification Tower) / 2018 Nuclear Society Exhibition (Stateless Art Space) / 2018 'It Hurts' Solo Exhibition (Namu Art) / 2017 Bitter Taste Is the Taste of Life Group Exhibition (Insa Art Plaza) / 2016 Chilmoe Kimgu Invitational (Gallery Hwain Arts) / 2013 'Back Alley Story' Solo Exhibition (Gyeongin Gallery) / 1986 Fresh Statements by Young Generations (Geurim Madang Min) / 1985 1980s Representative Works Exhibition (Geurim Madang Min) / 1985 40th Liberation Anniversary Memorial Street Solo Exhibition (Ganghwa Market) / 1984 Local Artist Exhibition (Chilmoe Gallery) / 1983 Indépendant Exhibition (MMCA) / 1982 Dong-A Art Festival Entry (MMCA)`,
  },
  한애규: {
    name_en: 'Han Aekyu',
  ...
  홍진희: {
    ...
    history_en: `B.F.A., College of Fine Arts, Hongik University
...
Current: Member, Korean Fine Arts Association`,
  ...
  김레이시: {
    name_en: 'Lacey Kim',
    profile: `예술은 제게 삶의 본질이자 자연스러운 흐름이었습니다. 서울여자대학교 서양화과를 졸업하고, 영국 노팅엄 트렌트 대학교와 미국 프랫 인스티튜트에서 석사과정을 마쳤습니다. 구상 작업으로 회화의 구조적 기반을 다진 뒤 추상 회화로 전환하면서, 내면의 균형과 존재의 본질을 선과 색으로 탐구해 왔습니다. 뉴욕, 시카고, 빈, 마이애미, 서울 등 여러 도시에서 전시를 이어오며 서로 다른 문화와 미적 감각이 교차하는 지점을 작업에 반영하고 있습니다. 제게 예술은 자신을 이해하고 타인과 연결되는 하나의 언어입니다. 관람자 각자의 감각과 경험이 작품 안에서 직관적으로 교류될 수 있는 가능성을 모색하고 있습니다. 현재는 이러한 경험을 바탕으로 예술의 교육적 확장에도 관심을 두고, 창작과 나눔이 공존하는 예술 활동을 지속하고 있습니다.`,
...
One Medical Group (Cobble Hill, Brooklyn Location), Seoul Eastern District Court`,
  ...
  김태균: {
    name_en: 'Kim Taekyun',
    profile: `김태균은 풍경과 영토의 시선을 다층적으로 재구성해 온 시각예술가다. 독일 슈투트가르트와 한국을 오가며 활동했으며, 〈각색된 영토〉(2019 김종영미술관 창작지원전), 〈영원한 휴가〉(2013 서울시립미술관 신진작가 선정전, 스페이스 캔), 〈풍경의 그늘〉(2011 독일 에힝엔 시립미술관) 등의 개인전을 열었다. 〈경계 155〉(2017 서울시립미술관), 〈살롱 드 세마〉(2015 서울시립미술관 신소장 작품전), 〈상상의 공식〉(2019 부산현대미술관 신소장 작품전), 〈BETWEEN WAVES〉(2014 아모레퍼시픽 미술관 APMAP) 등 주요 미술관 기획전에 참여했다.`,
    profile_en: `Kim Taekyun is a visual artist who reconstructs the gaze of landscape and territory in multilayered fashion, having worked between Stuttgart, Germany and Korea. His solo exhibitions include 〈Adapted Territory〉 (Kim Chong Yung Museum Creative Support Exhibition, 2019), 〈Eternal Vacation〉 (Seoul Museum of Art Emerging Artist Selected Exhibition at Space Can, 2013), and 〈Shadow of Landscape〉 (Ehingen Municipal Museum of Art, Germany, 2011). He has participated in major museum exhibitions including 〈Border 155〉 (SeMA, 2017), 〈Salon de SeMA〉 (SeMA New Acquisitions Exhibition, 2015), 〈Formula of Imagination〉 (Busan Museum of Contemporary Art New Acquisitions Exhibition, 2019), and 〈BETWEEN WAVES〉 at Amorepacific Museum's APMAP (2014).`,
...
2006 Kunst Projekt 'Vor Fahrt', Birkenwald Straße, Stuttgart, Germany`,
  },
  박은선: {
    name_en: 'Park Eunsun',
...
Cultural: TV Show Jingpum Myeongpum / Korean Table / Gugak Hanmadang / Korean Language Challenge / Myeongyeonmanri / and others`,
  },
  조이락: {
    name_en: 'Jo Irak',
...
Lecturer, Muwoosoo Academy`,
  ...
  Salnus: {
    name_en: 'Salnus',
    profile: `살누스는 서울을 기반으로 활동하는 회화 및 드로잉 작가다. 회화, 드로잉, 설치, 애니메이션 등 다양한 매체를 실험해 왔으며, 최근에는 페인팅과 드로잉을 중심으로 작업을 이어간다. 작업은 기하학적 구조, 투명한 오브제, 구(球)와 원형 구조, 신체의 변형된 이미지 등을 반복적으로 다루며, 관음, 그로테스크, ‘보여짐과 가려짐’의 관계를 주요한 주제로 삼는다.\n살누스는 특히 유리, 수정구슬, 반투명한 구조물 등 투명한 재료와 기하학적 형식을 통해 장식성과 폭력성, 질서와 불안정성 사이의 긴장을 화면 안에 병치시키는 작업을 지속해 왔다. 회화와 설치, 평면과 입체, 서사와 구조 사이를 넘나드는 방식으로, 감각적이면서도 구조적인 이미지 세계를 구축하는 데 관심을 둔다.\n서울을 중심으로 활동하며, 개인전 《역추격》(2014)을 비롯해 다수의 기획전에 참여했다. 최근에는 과거의 드로잉과 에스키스를 확장한 설치 작업과, ‘구슬을 따라간 뱀의 이야기’ 연작을 통해 평면과 입체, 전시 공간 전체를 하나의 서사적 구조로 엮는 방식의 작업을 전개한다.`,
...
2020 Yeongcheon Art Creative Studio 12th Cohort Short-term Resident Artist`,
  ...
  이채원: {
    name_en: 'Lee Chaewon',
    profile: `이채원은 미국 매릴랜드에서 활동하는 신진 회화 작가다. 2024년 Maryland Institute College of Art(MICA) 회화과를 summa cum laude로 졸업했고, 같은 해 매릴랜드 볼티모어의 Lazarus Hall Gallery에서 첫 개인전 〈To Be Continued〉를 열었다. 워싱턴DC 한국 영사관 〈Summer Comes to My Hometown, Seoul〉(2024), MICA Fox Gallery 〈Spotlight, Graduating Seniors in Focus〉(2024), Deckers Gallery 〈Juried Undergraduate Exhibition〉(2023) 등에 참여했으며, MICA Distinguished International Student Award(2022·2024), Presidential Scholarship 외 다수의 학교 장학·수상 경력이 있다.`,
    profile_en: `Lee Chaewon is an emerging painter based in Maryland, USA. She graduated summa cum laude from the Maryland Institute College of Art (MICA) with a B.F.A. in Painting in 2024 and held her first solo exhibition 〈To Be Continued〉 at Lazarus Hall Gallery in Baltimore the same year. Her group exhibitions include 〈Summer Comes to My Hometown, Seoul〉 at the Korean Consulate in Washington D.C. (2024), 〈Spotlight: Graduating Seniors in Focus〉 at MICA's Fox Gallery (2024), and the Juried Undergraduate Exhibition at Deckers Gallery (2023). She received the MICA Distinguished International Student Award (2022 and 2024), the Presidential Scholarship, and numerous other institutional honors.`,
...
MICA Visionary Scholarship`,
  ...
  조문호: {
    name_en: 'Jo Munho',
    profile: `사람만 찍는 다큐멘터리 사진가다. 청량리 사창가 여인, 강원도 산골 농민, 인사동 풍류객, 장터꾼, 쪽방촌 빈민을 렌즈에 담아왔다. 찾아가 촬영한 것이 아니라 현지에서 그들과 함께 살면서 작업해왔다. 『월간사진』, 『한국사협』, 『삼성포토패밀리』 편집장으로 일했으며, 1995년부터 10년간 「한국환경사진가회」 회장을 역임하며 우리나라 자연환경 기록에도 힘썼다. 현재 동자동 쪽방촌에 살며 빈민의 삶을 기록한다.`,
    history: `<개인전>
...
Publications: 'I Am a Farmer', 'Even If It Takes a Little Time', etc.`,
  },
  이문형: {
    name_en: 'Lee Munhyung',
    profile: `이문형은 한국 전통 민화의 도상과 색채를 현대 회화로 풀어내는 민화 작가다. 한뼘미술관(천안)에서 첫 개인전 〈이문형 개인전 2025〉를 열었으며, 한국미술관 〈민화의 비상전—제6장. 반복과 패턴〉을 비롯한 다수의 단체전과 제7회 대한민국 민화아트페어(SETEC) 개인 부스전에 참여했다. 제13회 현대민화공모전 우수상을 수상했다.`,
    profile_en: `Lee Munhyung is a minhwa (Korean folk painting) artist who renders the iconography and color of traditional Korean folk painting through contemporary painterly form. She held her first solo exhibition 〈Lee Munhyung Solo Exhibition 2025〉 at Hanppyeom Museum (Cheonan) and has participated in numerous group exhibitions including the 〈Flight of Minhwa Exhibition—Chapter 6: Repetition and Pattern〉 at the Korea Museum of Art, as well as a solo booth at the 7th Republic of Korea Minhwa Art Fair (SETEC). She received the Excellence Award at the 13th Contemporary Minhwa Competition.`,
...
2023.8-Present Chaekkiraut, Culture News, MHN Sports 'Picture Books Read by Cheon Jisu' Reviews`,
  },
  류호식: {
    name_en: 'Ryu Hosik',
    profile: `류호식 작가의 작품들은 부조리한 현실과 그 안에서 의미를 찾고자 하는 정서를 표명한다. 주로 자연에서 영감을 받는 그는 그 순간들의 소중함을 기록한다. 작가는 과거의 어둠을 통해 새로운 희망과 행복을 발견하며, 일상의 이상적인 순간을 간직하고자 하는 소망에서 작품을 제작한다. 류호식 작가는 '페이퍼클레이 페인팅' 기법을 사용한다. 1250도의 가마에서 소성되어 나온 작품들은 류호식 작가 작품 특유의 질감을 만들어낸다.`,
    history: ``,

    profile_en: `Ryu Hosik's works express the absurdities of reality and the emotions of seeking meaning within them. Primarily inspired by nature, he documents the preciousness of those moments. The artist discovers new hope and happiness through the darkness of the past, and creates his works out of a desire to preserve the ideal moments of daily life. Ryu Hosik employs a 'paper clay painting' technique, in which works fired in a kiln at 1,250°C produce the distinctive texture characteristic of his art.`,
  },
  김지영: {
    name_en: 'Kim Jiyoung',
    profile: `자연에서 영감을 받은 작품을 주로 만드는 도예가로, '순 돋는 나무', '나무 한 그루' 등의 시리즈를 통해 심플하고 자연주의적인 작품 세계를 보여준다.`,
    history: `도예가`,

    profile_en: `Kim Jiyoung is a ceramic artist primarily creating works inspired by nature. Through series such as Sprouting Tree and A Single Tree, she presents a simple, naturalistic artistic world.`,
    history_en: `Ceramicist`,
  },
  김태희: {
    name_en: 'Kim Taehee',
    profile: `서울과학기술대학교 도예과를 졸업한 도예가로, 전통 도자기를 재해석하여 각진 형태나 조각보 이미지를 결합한 현대적인 도예 작업을 선보인다.`,
    history: `서울과학기술대학교 도예과 졸업`,

    profile_en: `Kim Taehee is a ceramic artist who graduated from Seoul National University of Science and Technology's Department of Ceramics. She presents contemporary ceramic works that reinterpret traditional pottery by incorporating angular forms and jogakbo (patchwork wrapping cloth) imagery.`,
    history_en: `B.F.A., Department of Ceramics, Seoul National University of Science and Technology`,
  },
  김정원: {
    name_en: 'Kim Jeongwon',
    profile: `김정원은 일상 속 인물의 자세와 정서를 회화로 옮겨 가는 작가다. 〈손 모은 사람〉을 비롯한 작업을 통해 평범한 몸짓에 깃든 마음의 결을 화면에 담는다.`,
    profile_en: `Kim Jeongwon is a painter who translates the postures and emotions of figures from everyday life into painting. Through works such as 〈Hands Together〉, she captures the textures of feeling embedded in ordinary gestures on canvas.`,
    history: ``,
  },

  민병산: {
    name_en: 'Min Byungsan',
    profile: `민병산(閔炳山, 1928~1990) 작가는 '거리의 철학자', '한국의 디오게네스'로 불린 충북 청주 출신의 문필가, 서예가로, 자유분방한 삶과 독특한 '민병산체' 서체, 그리고 '철학의 즐거움' 같은 산문집으로 알려져 있으며, 세속을 초월한 삶을 실천했던 예술가다.`,
    history: ``,

    profile_en: `Min Byungsan (1928–1990) was a literary figure and calligrapher from Cheongju, North Chungcheong Province, known as the 'Street Philosopher' and 'Korea's Diogenes.' He was celebrated for his freewheeling lifestyle, his distinctive 'Min Byungsan Style' calligraphy, and essay collections such as The Joy of Philosophy. He was an artist who practiced a life transcending worldly conventions.`,
  },
  하선영: {
    name_en: 'Ha Sunyoung',
    profile: `하선영은 홍익대학교에서 회화를 전공한 후 프랑스 아를국립사진학교에서 사진을 전공하였다. 나무의 초상화 작업과, 이후 팬데믹 시대의 힘겨운 사람들에게 아름다운 세계의 자연을 소재로 한 작품으로 우리에게 위안을 주는 작업을 계속한다.`,
    history: ``,

    profile_en: `Ha Sunyoung majored in painting at Hongik University before studying photography at the École Nationale Supérieure de la Photographie d'Arles in France. She has continued working with portraits of trees, and subsequently with works featuring the beautiful natural landscapes of the world, offering solace to people enduring the hardships of the pandemic era.`,
  },

  정재철: {
    name_en: 'Jeong Jaecheol',
    profile: `홍익대학교 회화과를 졸업했다. 'Middle Ground'는 그의 대표 추상 회화 시리즈로, 두터운 질감과 긁어내는 기법을 통해 관계와 갈등, 그리고 타협의 과정을 시각적으로 표현한다.`,
    history: `홍익대학교 회화과 졸업`,

    profile_en: `Jeong Jaecheol graduated from Hongik University's Department of Painting. Middle Ground is his representative abstract painting series, which visually expresses the processes of relationship, conflict, and compromise through thick textures and scraping techniques.`,
    history_en: `B.F.A., Department of Painting, Hongik University`,
  },
  장희진: {
    name_en: 'Jang Heejin',
    profile: `홍익대를 졸업하고 동 대학원(박사)을 마쳤다. 캔버스 표면의 요철과 색채의 상호작용을 탐구하는 'Folded tint' 시리즈로 유명한 장희진 작가는 캔버스 위에 모델링 컴파운드를 바른 뒤, 요철을 만들고 그 위에 채색을 입힌 후 표면을 갈아내는 수행적인 노동집약적 작업 과정을 통해 독특한 질감과 시각적 깊이를 만들어낸다. 이러한 작업을 통해 평면 회화의 한계를 넘어 공간적 깊이와 리듬감을 표현한다.`,
    history: `홍익대학교 미술대학 회화과 및 동대학원 회화과 졸업\n홍익대학교 일반대학원 미술학과 회화전공 박사 졸업`,

    profile_en: `Jang Heejin graduated from Hongik University and completed her Ph.D. at the same institution. Known for her Folded Tint series, which explores the interplay of surface texture and color on canvas, Jang creates distinctive texture and visual depth through a labor-intensive, performative process of applying modeling compound to the canvas, creating relief patterns, applying paint, and then sanding the surface. Through this practice, she transcends the limitations of flat painting to express spatial depth and rhythm.`,
    history_en: `B.F.A. and M.F.A., Department of Painting, College of Fine Arts and Graduate School, Hongik University
Ph.D., Painting, Graduate School, Department of Fine Arts, Hongik University`,
  },

  김유진: {
    name_en: 'Kim Yujin',
    profile: `'폭발의 다음' 시리즈 등으로 감정이 담긴 풍경과 관계 속의 외로움을 주제로 작업한다. 오픈갤러리 등 다양한 플랫폼에서 활동한다.`,
    history: `오픈갤러리 등록 작가`,

    profile_en: `Kim Yujin explores emotion-laden landscapes and loneliness within relationships through series such as The Day After the Explosion. She is active on various platforms including Open Gallery.`,
    history_en: `Registered artist at Open Gallery`,
  },
  고자영: {
    name_en: 'Ko Jayoung',
    profile: `서울대학교 미술대학 박사를 졸업했다. '정원'과 '식물'을 소재로 자아와 세상의 이치를 탐구하는 작업을 지속해오고 있으며, 2007년 세오 영 아티스트로 선정된 바 있다.`,
    history: `학력
서울대학교 미술대학 박사
...
논문
2001 식물을 소재로 한 다층적 시각체험의 표현연구`,

    profile_en: `Ko Jayoung holds a Ph.D. from Seoul National University's College of Fine Arts. She has continuously explored the self and the principles of the world through the subjects of 'gardens' and 'plants,' and was selected as the SEO Young Artist in 2007.`,
    history_en: `Education
...
Major collections: National Museum of Modern and Contemporary Art (MMCA), Lee Young Contemporary Art Museum, Gallery Hyundai`,
  ...
  강레아: {
    name_en: 'Kang Lea',
    profile: `강레아 작가는 한국 최초의 여성 클라이밍 및 산악 사진작가로, 암벽에 핀 소나무 등 자연의 강인한 생명력을 포착하는 작품으로 유명하며, 디자이너 출신으로 늦게 사진에 입문하여 신구대학교 사진과를 졸업 후 전문 사진작가로 활동한다. 강레아의 작품은 한국을 넘어 프랑스 등 해외에서도 전시되며, 강인하면서도 서정적인 시선으로 산과 바위를 담아내는 것으로 평가받는다.`,
    history: ``,
    profile_en: `Kang Lea is recognized as Korea's first female climbing and alpine photographer, known for capturing the resilient vitality of nature—such as pine trees clinging to cliff faces. Originally a designer, she came to photography later in life and graduated from the Department of Photography at Shingu College, where she now works as a professional photographer. Her works have been exhibited not only in Korea but also abroad, including France, and are praised for their resolute yet lyrical gaze upon mountains and rocks.`,
  },
  림지언: {
    name_en: 'Lim Jieon',
    profile: `림지언은 일상의 순간과 자연의 결을 회화로 옮겨 가는 작가다. 〈모먼트〉, 〈진달래 진달래〉, 〈풀, 꽃!〉 등의 작업을 통해 평범한 풍경에 깃든 정서를 색채와 선으로 풀어낸다. 2018년 서울에서 첫 개인전을 열었으며 2025년 서울 단체전에 참여했다.`,
    history: `2018 개인전(서울)\n2025 단체전(서울)`,
    profile_en: `Lim Jieon is a painter who translates everyday moments and the textures of nature into painting. Through works such as 〈Moment〉, 〈Azalea, Azalea〉, and 〈Grass, Flower!〉, she unfolds the sentiments embedded in ordinary landscapes through color and line. She held her first solo exhibition in Seoul in 2018 and participated in a group exhibition in Seoul in 2025.`,
  },
  민정기: {
    name_en: 'Min Joung-Ki',
    profile: `민정기(閔晶基, Min Joung-Ki, b.1949)는 '현실과 발언' 창립회원으로 1979년말 '현실과 발언' 창립 초기부터 공식적 해체기(1990)까지 민중미술진영의 주요 작가로서 참여했으며, 또한 90년대 이후부터는 경기도 양평으로 거소를 옮겨 '산과 땅과 더불어 살아가는' 인간의 삶의 회화적 기록이라 이름할 산수화, 화훼화를 그려내고 있다. 민정기의 작품세계는 초기, 소위 '이발소그림'으로 통칭되는 촌스럽고 세련되지 않은 그림을 다시 모방해 고급미술의 회랑에 내놓았다. '통속'의 사회에서 통속적으로 살고 있다는 우리 모두의 자의식을 건드린 것이다. 반미학적 다다이스트적 기획이라는 점에서 음울한 시대의 알레고리로 읽혀졌다. 이후 그는 숲으로, 정확히는 땅을 향해, 역사의 지층을 향해 걸어갔다. 그러다 저잣거리로 나서 길·도로·강물의 흐름을 따라가는 '오늘로 향하는 길'을 그렸다. 양평 시대의 '산수화'들은 산세와 지세 가운데 삶의 거처를 정하고, 이를 풍수의 지혜로 여겼던 옛사람들의 사유를 잇는다.`,
    history: ``,
    profile_en: `Min Joung-Ki (b. 1949) was a founding member of 'Reality and Utterance' (Hyeonsil-gwa Bareon), participating in the Minjung (People's) Art movement from its inception in late 1979 to its formal dissolution in 1990. Since the 1990s, he has lived in Yangpyeong, Gyeonggi-do, painting landscapes (sansuhwa) and floral works that he describes as painterly records of human life living together with mountains and earth. His early work, which re-imitated the unrefined so-called barbershop paintings and brought them into the corridors of high art, touched the self-consciousness that all of us live conventionally in a conventional society—an anti-aesthetic, dadaist enterprise read as an allegory of a somber era. He then walked toward the forest—more precisely, toward the earth and the strata of history—and later out into the marketplace, following roads, paths, and the flow of rivers as 'paths toward today.' His Yangpyeong-era landscapes set their dwelling within mountain ranges and terrain, regarding this as the wisdom of pungsu (geomantic harmony) once held by people of old.`,
  },
  박영선: {
    name_en: 'Park Youngsun',
    profile: `박영선은 중국 루쉰 미술대학에서 수학한 판화가이자 화가로, 현재 인도 오로빌에 거주하며 작업한다. 동아대학교 미술대학에서 미술을 전공한 이후, 중국 현대 판화 교육의 중심지인 루쉰 미술대학에서 판화 기반의 회화와 조형 언어를 체계적으로 익혔다. 중국 유학 시기부터 판화의 선과 면, 반복과 축적의 방식을 중심으로 작업을 이어온 그는, 이후 인도 오로빌에 정착하며 작업의 환경과 범위를 확장해 왔다. 오로빌은 국적과 종교, 이념을 넘어선 국제 공동체로, 박영선은 이곳에서의 삶과 예술 실천을 통해 공동체, 노동, 자연, 인간의 존엄이라는 주제를 지속적으로 탐구해 왔다. 출판으로 《까이비간》(산지니, 2007)이 있다.`,
    history: ``,
    profile_en: `Park Youngsun is a printmaker and painter who studied at the Lu Xun Academy of Fine Arts in China and currently lives and works in Auroville, India. After majoring in art at Dong-A University's College of Fine Arts, she systematically learned printmaking-based painting and formative language at the Lu Xun Academy of Fine Arts—a center of contemporary Chinese print education. From her studies in China, she has continued working with the lines, planes, repetitions, and accumulations of printmaking, later expanding her practice's environment and scope by settling in Auroville. Auroville is an international community that transcends nationality, religion, and ideology, and through her life and artistic practice there, Park has continuously explored themes of community, labor, nature, and human dignity. Her published works include 〈Kkaibigan〉 (Sanji-ni, 2007).`,
  },
  서공임: {
    name_en: 'Seo Gongim',
