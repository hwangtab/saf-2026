...
생명력과 역동적 에너지가 느껴지는 나의 파도는 관람객에게 삶의 새로운 비상과 도약을 이끈다. 도전하는 용기와 성장, 희망을 전달한다. 또한 관람객에게 파도치는 대 도약의 감정을 이끌어내기 위해 입체적 질감과 파도의 군열을 최대한 사실적으로 표현했다. Glory_moment#+ 시리즈를 통해 다양한 블루의 심연을 느껴보기 희망한다.`,
    profile: '',
    size: '60.6x60.6cm',
