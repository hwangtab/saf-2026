...
export const faqs: FAQItem[] = [
  {
    ...
    answer:
      '씨앗페 온라인은 한국 예술인들의 상호부조 대출 기금을 마련하는 특별전입니다. 조합원 가입과 작품 구매로 예술인들이 더 안정적으로 창작할 수 있는 환경을 만듭니다.',
  },
  {
    question: '조합원 가입은 어떻게 하나요?',
    answer:
      '홈페이지의 "조합원 가입" 버튼을 누르면 한국스마트협동조합의 일원이 됩니다. 조합원 가입으로 예술인 상호부조 기금 조성과 운영에 꾸준히 힘을 보태주세요.',
  },
  {
    question: '전시는 언제 어디서 열리나요?',
    answer:
      '오프라인 전시는 2026년 1월 26일 성황리에 종료되었습니다. 온라인 전시는 이 사이트에서 상설로 이어지므로, 언제든 작품을 감상하고 구매하실 수 있습니다.',
  },
  {
    question: '상호부조 대출이란 무엇인가요?',
    answer: `제1금융권에서 소외된 예술인에게 조성된 기금을 바탕으로 연 5%의 고정금리 대출을 제공하는 제도입니다. 현재 ${repaymentRate}의 높은 상환율을 유지하고 있습니다.`,
  },
  {
    question: '씨앗페 온라인의 목표 금액은 얼마인가요?',
    answer: `이번 캠페인은 총 ${loanGoal} 원의 상호부조 대출 가능 기금 확보를 목표로 합니다. 여러분의 조합원 가입과 작품 구매가 이 목표를 가능하게 합니다.`,
  },
  {
    question: '구매한 작품의 배송은 어떻게 이루어지나요?',
    answer:
      '주문 금액 20만원 이상은 기본 무료 배송(미만 시 4,000원)입니다. 단, 대형 작품(세 변의 합 180cm 이상)이나 파손 위험이 있는 작품(유리, 도자 등)은 미술품 전문 운송 차량으로 배송하며 지역에 따라 별도 비용(3.5만원~30만원)이 발생할 수 있습니다. 평균 배송일은 결제 확인 후 영업일 기준 3~4일입니다.',
  },
  {
    question: '씨앗페 온라인 전시를 즐기는 방법은 무엇인가요?',
    answer: `작품 갤러리(saf2026.com/artworks)에서 회화·판화·사진·조각 ${ARTWORK_COUNT}점을 자유롭게 살펴보고 마음에 드는 작품을 구매하세요. 매거진에서는 작가 인터뷰와 컬렉팅 가이드를, 아카이브에서는 오프라인 전시 현장 기록과 포스터를 만날 수 있습니다.`,
  },
];
