...
export const artworks: Artwork[] = [
  ...
  },
  {
    ...
    "artist": "신학철",
    "title": "무제",
    "description": "“하나의 생명을 낳는 것은 하나의 죽음을 낳는 것과 같다.” 생명은 결국 죽음을 맞이할 수밖에 없으며, 내 생명의 주체인 자신과, 나의 생명을 낳는 주체는 항상 다른 인물일 수밖에 없다. 자신이 낳지 않은 자신의 삶을 살아가야 하는 고됨, 죽음이 다가오는 불안. 그 사이에서 벌어지는 수많은 충돌과 좌절과 허무. 생과 사가 결정되기 이전의 장소인 연옥을 관찰하게 된 것은 어쩌면 필연적인 과정이었을지도 모른다. 삶과 죽음의 굴레에서 벗어나, 자유롭게 존재할 수 있는 대안 공간을 찾고 있던 나에게, 연옥이란 나의 먼 과거의 전생과 전생에서부터 이어져온, 내 곁에 항상 존재했던 곳이었음을.",
