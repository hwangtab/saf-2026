...
export const artworks: Artwork[] = [
  ...
  },
  {
    ...
    "artist": "최은경",
    "title": "차창 밖, 겨울 능선",
    "description": "최은경은 회화의 ‘붓질’이란 삶의 구체성을 표현하기 위한 전제로 다시 조우해야만 하는 잊힌 (원)기억에 의해 직조되는(재구성되는) - 대립하는 양극이 아니라 막대자석과 자기장의 원리(구조적 자리) 사이의 차이처럼 작동하는 - 허구의 내러티브이자 실재의 사실성이 아닐까 하는 추론으로 작업한다.\n\n<모퉁이로 미끄러지는 풍경(들)>(2024)은 영정(影幀)의 의미가 형상(삶)과 형상 옆으로 드리워진 그림자(죽음)를 담은 그림틀이듯이, 인생의 귀결에서 우리 모두의 영정은 어떻게 표현될(할) 수 있을까, 혹은 어떤 귀결로 흔적을 남길까,라는 질문의 초고로부터 시작한다.",
    ...
    "image": "54.jpeg",
    "shopUrl": "",
    "history": "차창 밖으로 무심코 보게 된 전라도 정읍 외곽 일대의 겨울 풍경이다. 부모님 집이었던 고부면 관청리에서 정읍 시내를 오고 갈 때마다 차창 밖으로 본 정경(情景)들로 10여 년 전에 찍은 사진 이미지를 토대로 다시 그렸다. 이 풍경들을 바라볼 때의 ‘감정’은 그야말로 날씨처럼 시시때때로 바뀌게 된다. 폐허경(景)에 가까운 낙후된 현실 풍경으로 황폐하고 비루하다고 느끼게 되는 반면, 양가적으로 마치 본향(本鄕)의 회귀본능처럼 거기서 밀려오는 어떤 애잔함으로 향수나 그리움을 느끼게 되기도 하다."
  },
  {
    "id": "55",
    "artist": "정미정",
