...
1974년 오윤이 새긴 양면 테라코타 부조가 서울 광진구 구의동에 있습니다. 건물 매매와 함께 **2026년 8월 철거가 예정**되어 있고, 행정 절차도 이미 진행 중입니다.
...
그래서 시민이 먼저 움직입니다. 작품을 안전하게 해체하고 미술품 전용으로 운송해 보존 처리하고 보관할 비용 — **목표 1억 원**을 모읍니다. **목표에 도달하지 못하더라도, 모인 만큼 즉시 작품 이전에 집행합니다.** 벽이 무너지기를 기다릴 수 없기 때문입니다.
...
후원해 주시면 **오윤 작품 엽서**를 답례로 보내드립니다(1만 원부터). 더 큰 후원에는 감사장과 함께 **오윤 사후판화**를 드립니다.
