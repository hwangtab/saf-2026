...
### 배치 6 (안내·기술 가이드 + soft 항목 — 2026-06-09)

- **meet-artist-ateumandu**(EN): 작가명 본문 "Ateumandu"(9회) → **"Artmandu"**(title_en·교차링크 10편과 통일); 단체전 EN "Korean **Cellatist** Association"(첼리스트 오역) → KO 〈한국샐라티스트협회전〉에 맞춰 **"Korean Sallatist Association"**.
- **7-mistakes-first-time-collectors**(KO+EN): 소제목 "액자·배송·**세금** 간과"가 본문에 세금 설명 없음 → "액자·배송 비용 간과 / Ignoring Frame and Delivery Costs"로 정정.
- 검증 통과(오류 없음): art-care-and-maintenance·how-to-appreciate-art·how-to-enjoy-art-exhibitions·what-is-an-artist-profession·art-without-museums·do-you-need-art-education-to-collect / artwork-care-guide·choosing-by-medium·framing-and-mounting-artworks·moving-and-shipping-artworks·tools-for-hanging-artworks·how-to-hang-artwork / kim-suoh·how-artwork-prices-work·five-criteria — 기술·재료·기관 사실 모두 통설 부합. (배치 5 URL·마에자와·복지법·실리카겔·석고보드·콘크리트못·치수·kang-seoktae 논리·kim-suoh sold는 이미 반영됨.)
- 미수정(범위 외/비-오류): how-artwork-prices 호수표 F/P 혼용(approximate 명시, P형 수치도 유효), choosing-by-medium 작품수 통계(동적 변수), 127/354 하드코딩(DB 본문이라 i18n 변수 불가), diasec 표현 차이.
