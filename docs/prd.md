...
#### **1.1. 배경 (Background)**
대한민국 예술인들은 제도권 금융 시스템의 구조적 문제로 인해 심각한 금융 소외를 겪고 있다. <2025 예술인 금융 재난 보고서>에 따르면, 예술인의 84.9%가 제1금융권에서 배제되고, 48.6%가 약탈적 고금리에 노출되는 등 ‘사회적 재난’ 수준의 위기에 처해있다. 이에 한국스마트협동조합은 예술인 상호부조 대출 기금 확충 및 문제 공론화를 위해 예술 축제 ‘씨앗:페(SAF)’를 개최한다. 본 웹사이트는 이 캠페인의 핵심 디지털 허브 역할을 수행한다.
...
*   **Phase 1 (MVP 출시)**: 2025년 11월 15일
    *   **포함 기능**: 모든 페이지의 기본 구조 및 콘텐츠, 후원/온라인 갤러리 링크, 전시 안내(지도 포함).
    *   **목표**: 캠페인 런칭에 맞춰 핵심 정보 제공 및 참여 채널 오픈.
*   **Phase 2 (고도화)**: 2025년 12월 1일
    *   **포함 기능**: '아카이브' 페이지(영상, 언론보도) 콘텐츠 추가, 인터랙티브 애니메이션 효과 적용.
    *   **목표**: 행사일에 가까워지면서 방문자들의 재방문과 지속적인 관심을 유도.
...
| :--- | :--- | :--- | :--- | :--- |
| **참여 예술가 목록** | `/content/artists.ts` | 개발자가 .ts 파일 수정 후 Github Push | (개발 담당자) | 행사 전 확정 |
