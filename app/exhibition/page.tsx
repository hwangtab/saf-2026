  ...
  return (
    <>
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="flex flex-col gap-8 h-full">
              <div>
                <h2 className="font-jeju-stone text-3xl md:text-4xl mb-6">전시 정보</h2>
      ...
      <section className="py-12 md:py-20 bg-accent-soft">
        <div className="container-max">
          <h2 className="font-jeju-stone text-3xl md:text-4xl mb-12">오시는 길</h2>
      ...
      <section className="py-12 md:py-20 bg-gray-50">
        <div className="container-max">
          <h2 className="font-jeju-stone text-3xl md:text-4xl mb-12">행사 일정</h2>
      ...
      <section className="py-12 md:py-20 bg-primary/20">
        <div className="container-max text-center">
          <h2 className="font-jeju-stone text-3xl md:text-4xl mb-8">문의사항</h2>
          <div className="space-y-4">
