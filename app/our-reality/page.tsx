    ...
    <>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="container-max">
          <div className="max-w-3xl mx-auto text-balance">
            <h2 className="font-section font-normal text-4xl md:text-5xl mb-8 text-center">예술인에게 금융은 산소호흡기</h2>
      ...
      <section className="py-12 md:py-20 bg-primary-surface">
        <div className="container-max">
          <div className="mb-12">
            ...
            <h2 className="font-section font-normal text-4xl md:text-5xl mb-4">닫힌 문: 은행이 거절하다</h2>
      ...
      <section className="py-12 md:py-20 bg-accent-soft">
        <div className="container-max">
          <div className="mb-12">
            ...
            <h2 className="font-section font-normal text-4xl md:text-5xl mb-4">낭떠러지: 고리대금로 내몰리다</h2>
            <p className="text-xl text-charcoal-muted max-w-2xl leading-relaxed">
      ...
      <section className="py-12 md:py-20 bg-red-100">
        <div className="container-max">
          <div className="mb-12">
            ...
            <h2 className="font-section font-normal text-4xl md:text-5xl mb-4">파괴: 창작이 멈춘다</h2>
            <p className="text-xl text-charcoal-muted max-w-2xl leading-relaxed">
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="container-max max-w-3xl">
          <h2 className="font-section font-normal text-4xl md:text-5xl mb-8 text-center">이것은 개인의 문제가 아닙니다</h2>
          <div className="space-y-6 text-lg text-charcoal">
            <p>
      ...
      <section className="py-12 md:py-20 bg-canvas-soft">
        <div className="container-max">
          <h2 className="font-section font-normal text-4xl md:text-5xl mb-8 text-center">산소호흡기가 필요하다</h2>
      ...
      <section className="py-12 md:py-20 bg-primary/20">
        <div className="container-max text-center">
          <h2 className="font-section font-normal text-4xl md:text-5xl mb-6">이제 행동할 시간입니다</h2>
