      ...
      <div className="max-w-md w-full space-y-8 text-center bg-white p-10 rounded-xl shadow-md">
        <div>
          ...
          <p className="mt-6 text-sm text-gray-600 leading-relaxed">
            {isEnglish ? 'Your application has been submitted.' : '회원가입 신청이 접수되었습니다.'}
            <br />
            {isEnglish
              ? 'You can start artist activities after admin approval.'
        ...
        <div className="rounded-md bg-green-50 px-4 py-3 text-sm text-green-700">
          {isEnglish ? 'Submitted:' : '제출 완료:'} {application?.artist_name}
        </div>
