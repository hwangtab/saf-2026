...
export default function AdminLoading() {
  return (
    <div aria-hidden="true" className="min-h-screen bg-[var(--admin-bg)]">
      ...
      <div className="fixed left-0 top-0 z-30 w-full border-b border-gray-200/90 bg-white/90 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="h-7 w-28 animate-pulse rounded bg-gray-200" />
          <div className="hidden h-8 w-24 animate-pulse rounded-full bg-gray-100 sm:block" />
        </div>
      </div>
