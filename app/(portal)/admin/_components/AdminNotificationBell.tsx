  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {/* suppressHydrationWarning: SSR(lastSeenAt=null)와 client(localStorage값) 간 className 차이 억제 */}
        <span
          aria-hidden="true"
          suppressHydrationWarning
          className={`absolute -right-0.5 -top-0.5 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-danger-a11y px-1 text-[10px] font-bold leading-none text-white${unreadCount === 0 ? ' hidden' : ''}`}
        >
