      ...
      <Section variant="sun-soft" prevVariant="white">
        <div className="container-max flex flex-col gap-8">
          <div className="max-w-3xl space-y-4">
            ...
            <div className="h-10 w-full md:w-2/3 bg-gray-200 rounded animate-pulse" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[...Array(2)].map((_, i) => (
              <div
                key={i}
                className="h-64 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm animate-pulse"
              >
