    ...
    <>
      ...
      <section className="py-16 md:py-24 bg-sun-soft">
        <div className="container-max">
          <h2 className="font-section font-normal text-4xl md:text-5xl text-center mb-12">
            우리가 직면한 문제
          </h2>
      ...
      <section className="py-16 md:py-24 bg-accent-soft">
        <div className="container-max">
          <h2 className="font-section font-normal text-4xl md:text-5xl mb-12 text-center">
            당신도 함께할 수 있습니다
          </h2>
