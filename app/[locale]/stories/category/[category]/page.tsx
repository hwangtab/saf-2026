...
function buildCategoryMeta(
  artistCount: number
): Record<LocaleCode, Record<StoryCategory, CategoryEditorial>> {
  return {
    ko: {
      'artist-story': {
        title: '작가를 만나다 — 작가 인터뷰 & 스토리',
        description:
          '씨앗페 출품 작가들의 이야기를 만나보세요. 작품 세계관과 창작 과정, 작가 인터뷰로 한국 현대미술의 깊이를 경험하세요.',
        heroTitle: '작가를 만나다',
        ...
        editorialIntro: `작품 한 점이 만들어지기까지 작가는 어떤 시간을 보냈을까요. 씨앗페 2026에는 회화·판화·사진·조각으로 자신의 세계를 짓는 ${artistCount}명의 한국 작가가 모였습니다. 그들이 동료 예술인을 위해 작품을 내놓은 이유부터 작업실의 일상, 작품 너머의 사유까지 — 한 작품을 진짜로 ‘본다’는 것은 그 작가를 아는 일에서 시작됩니다.`,
        editorialParagraphs: [
      ...
      'buying-guide': {
        ...
        editorialParagraphs: [
          ...
          `씨앗페 온라인은 화랑 수수료가 끼지 않는 작가 직매 구조입니다. 작품 판매 수익은 ${LOAN_COUNT}건의 저금리 대출(95% 상환율)로 운영된 예술인 상호부조 기금이 됩니다. 한 점을 사는 일이 한 명의 작가를 응원하는 데서 끝나지 않고 한국 예술 생태계의 작은 안전망을 보태는 일이 됩니다. 그래서 “왜 이 갤러리에서 사야 하는가”에 대한 답이 가격표 너머에 있습니다.`,
          '구매 절차는 단순합니다. 마음에 드는 작품을 클릭하고 작가·재료·크기·가격을 확인한 뒤 토스페이먼츠로 결제하면, 작품 상태 확인과 안전 포장 후 발송됩니다. 액자 제작이 필요한 작품은 제작 기간 때문에 보통 1~2주가 걸릴 수 있고, 액자 제작이 필요 없는 작품은 보통 3~4일 안에 받을 수 있습니다. 7일 이내 반품도 가능합니다. 처음에는 가격대가 부담 없는 판화나 소형 회화로 시작하는 분이 많습니다. 가격대별 필터로 예산에 맞는 작품을 추리고 인테리어와 어울리는지 작품 옆 사진을 함께 확인해 보세요.',
        ],
        faqs: [
          {
            question: '미술 작품을 처음 사는데 얼마부터 시작해야 하나요?',
            answer:
              '15만원~50만원대에서는 신진 작가의 소형 사진·판화·디지털아트로 시작할 수 있습니다. 50만원~150만원대는 거장의 사후 판화·중견 작가 회화 진입점, 150만원 이상은 거실 메인 한 점 또는 평생 가는 한 점에 적합합니다.',
          },
          {
            question: '원본과 판화·디지털 프린트는 어떻게 다른가요?',
            answer:
              '원본은 작가가 직접 만든 1점뿐인 작품(회화·조각·일부 사진)입니다. 판화는 원판으로 한정 부수 인쇄(예: 30/50)된 작품으로 작가가 직접 찍은 “생전 판화”와 사후 유족·재단이 인쇄한 “사후 판화”로 나뉩니다. 디지털 프린트는 작가가 색을 감수한 한정 출력본입니다. 모두 진짜 작품이고 작가 서명·에디션 번호·증명서가 동봉됩니다.',
          },
          {
            question: '작품 구매 후 액자·배송·보관은 어떻게 하나요?',
            answer:
              '액자는 작품마다 포함/미포함 표기됩니다. 액자 제작이 필요한 작품은 제작 기간 때문에 결제 후 보통 1~2주가 걸릴 수 있고, 액자 제작이 필요 없는 작품은 보통 3~4일 안에 받을 수 있습니다. 7일 이내 단순 변심 반품도 됩니다. 보관은 직사광선·습기를 피하고 적정 온도·습도를 유지하면 30~50년 보존됩니다.',
          },
          {
      ...
      'art-knowledge': {
        ...
        editorialIntro:
          '미술이 어렵게 느껴지는 건 보는 사람의 잘못이 아닙니다. 너무 많은 “알아야 할 것”이 작품과 우리 사이를 가로막은 탓일 때가 많습니다. 미술 산책은 그 거리감을 줄이는 코너입니다. 한 작품을 어떻게 보면 좋은지, 미술사 속 어느 자리에 놓이는지, 전시장에서 무엇을 챙기면 더 잘 즐길 수 있는지 — 일상의 산책처럼 가볍게 건네는 미술 이야기입니다.',
        editorialParagraphs: [
          ...
          `읽다가 마음에 닿는 작가나 매체가 생기면 작품 갤러리에서 직접 그 결의 작품을 찾아보세요. 회화·판화·사진·조각 카테고리별로 ${artistCount}명 작가의 작품을 비교해 볼 수 있고, 가격대 필터로 부담 없이 시작할 수도 있습니다. 미술은 결국 좋아하는 작품을 한 점 들이는 데서 진짜로 시작됩니다.`,
        ],
        faqs: [
          {
          ...
          },
          {
            ...
            answer:
              '1970년대 단색화(서구 미니멀과 대화한 추상), 1980년대 민중미술(오윤·박재동·민정기 등 목판·사실주의), 1990년대 미디어아트(백남준 계보), 2000년대 이후 사진·설치·디지털 다양화. 거장 한 명의 작품을 보면 그 시대의 결을 짐작할 수 있습니다.',
          },
          {
            question: '판화는 어떻게 만들어지나요? 진짜 작품인가요?',
            answer:
              '작가가 직접 새긴 원판(목판·동판·실크스크린 등)으로 한정 부수 인쇄한 진짜 작품입니다. 작가가 직접 찍은 “생전 판화”와 작가 사후 유족·재단이 원판으로 인쇄한 “사후 판화”로 나뉘고, 둘 다 작가 서명 또는 에디션 번호·증명서를 갖춘 공식 작품입니다.',
          },
          {
          ...
          },
          {
            ...
            answer: `씨앗페 온라인은 한국 동시대 작가 ${artistCount}명의 작품을 회화·판화·사진·조각·디지털아트 카테고리로 모았습니다. 가격대 필터로 부담 없이 시작할 수 있고, 작품 페이지에서 작가 약력·재료·크기·매거진 인터뷰까지 한눈에 확인 가능합니다.`,
          },
        ],
      },
    },
    en: {
      'artist-story': {
        ...
        editorialIntro: `Behind every artwork is a life of decisions. SAF 2026 brings together ${artistCount} Korean artists who chose to put their work into a mutual-aid campaign for fellow artists. Their interviews, studio notes, and reflections give you the context that turns a passing glance into a lasting connection with a piece.`,
        editorialParagraphs: [
      ...
      'art-knowledge': {
        ...
        faqs: [
          ...
          },
          {
            ...
            answer: `SAF Online gathers ${artistCount} contemporary Korean artists across painting, print, photography, sculpture, and digital art. Filter by price, browse by artist, and read magazine interviews — all on one page.`,
          },
        ],
      },
    },
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const CATEGORY_META = buildCategoryMeta(artistCount);
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-5 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-sm text-charcoal-muted mt-1">
              {locale === 'en'
                ? `${artistCount} artists, artworks available online.`
                : `${artistCount}명의 작가, 지금 바로 구매 가능한 작품들`}
            </p>
          </div>
          <LinkButton
            href="/artworks"
