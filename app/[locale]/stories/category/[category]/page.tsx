    ...
    ko: {
      ...
      'buying-guide': {
        ...
        editorialParagraphs: [
          ...
          '구매 절차는 단순합니다: 마음에 드는 작품을 클릭 → 작가·재료·크기·가격을 확인 → 토스페이먼츠로 결제 → 작품 상태 확인과 액자 제작, 안전 포장 후 보통 1~2주 안에 발송. 7일 이내 반품도 가능합니다. 처음에는 가격대가 부담 없는 판화나 소형 회화로 시작하시는 분이 많습니다. 가격대별 필터로 예산에 맞는 작품을 추리고, 인테리어와 어울리는지 작품 옆 사진을 함께 확인해 보세요.',
        ],
        faqs: [
          {
          ...
          },
          {
            ...
            answer:
              '액자는 작품마다 포함/미포함 표기됩니다. 액자 제작이 필요한 작품은 결제 후 제작·검수·안전 포장을 거쳐 보통 1~2주 안에 발송됩니다. 7일 이내 단순 변심 반품 가능하며, 보관은 직사광선·습기를 피하고 적정 온도·습도를 유지하면 30~50년 보존됩니다.',
          },
          {
