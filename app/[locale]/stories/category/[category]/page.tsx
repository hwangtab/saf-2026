  ...
  return {
    ko: {
      'artist-story': {
        ...
        editorialIntro: `작품 한 점이 만들어지기까지, 작가는 어떤 시간을 보냈을까요. 씨앗페 2026에는 회화·판화·사진·조각으로 자신의 세계를 짓는 ${artistCount}명의 한국 작가가 모였습니다. 그들이 동료 예술인을 위해 작품을 내놓은 이유부터, 작업실의 일상과 작품 너머의 사유까지 — 한 작품을 진짜로 ‘본다’는 것은 그 작가를 아는 일에서 시작됩니다.`,
        editorialParagraphs: [
      ...
      'buying-guide': {
        ...
        editorialParagraphs: [
          ...
          '구매 절차는 단순합니다: 마음에 드는 작품을 클릭 → 작가·재료·크기·가격을 확인 → 토스페이먼츠로 결제 → 작품 상태 확인과 안전 포장 후 발송. 액자 제작이 필요한 작품은 제작 기간 때문에 보통 1~2주가 걸릴 수 있고, 액자 제작이 필요 없는 작품은 보통 3~4일 안에 받아보실 수 있습니다. 7일 이내 반품도 가능합니다. 처음에는 가격대가 부담 없는 판화나 소형 회화로 시작하시는 분이 많습니다. 가격대별 필터로 예산에 맞는 작품을 추리고, 인테리어와 어울리는지 작품 옆 사진을 함께 확인해 보세요.',
        ],
        faqs: [
          {
          ...
          },
          {
            ...
            answer:
              '액자는 작품마다 포함/미포함 표기됩니다. 액자 제작이 필요한 작품은 제작 기간 때문에 결제 후 보통 1~2주가 걸릴 수 있고, 액자 제작이 필요 없는 작품은 보통 3~4일 안에 받아보실 수 있습니다. 7일 이내 단순 변심 반품 가능하며, 보관은 직사광선·습기를 피하고 적정 온도·습도를 유지하면 30~50년 보존됩니다.',
          },
          {
