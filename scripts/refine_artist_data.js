...
function formatHistory(text) {
    ...
    const sectionHeaderRegex = /^(개인전|단체전|주요 경력|학력|수상|작품 소장|소장|전시 경력|그룹전|기획전|아트페어|레지던시|출판|워크샵|활동|현재|Solo Exhibition|Group Exhibition|Awards|Collection|Education)\s*$/i;
