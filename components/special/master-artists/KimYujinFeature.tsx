...
export default async function KimYujinFeature({
  ...
  const exhibitionEventSchema = {
    ...
    description: isEnglish
      ...
      : '씨앗페 온라인에서 만날 수 있는 김유진 작품을 소개합니다.',
    url: pageUrl,
                ...
                <div className="text-lg leading-[1.85] text-charcoal space-y-4 break-keep">
                  {isEnglish ? (
                    ...
                    <>
                      ...
                      <p>
                        그리고 그가 대체로 그 다음을 그리기에, 그의 풍경이 싣는 감정은 나직하다 —
                ...
                <p className="text-lg leading-[1.85] text-charcoal font-medium">
                  {isEnglish ? (
                    ...
                    <>
                      ...
                      그리고 사람들 사이에서. 씨앗페에는 이 캠페인의 대상이 아니라, 동료 예술인과의
                      연대자로 함께한다 — 작품 판매 수익이 오늘 금융 차별을 겪는 예술인에게 저금리의
                      버팀목이 될 수 있도록.
                    </>
                  )}
                </p>
