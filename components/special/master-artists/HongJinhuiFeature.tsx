...
export default async function HongJinhuiFeature({
  ...
  const exhibitionEventSchema = {
    ...
    description: isEnglish
      ...
      : '씨앗페 온라인에서 만날 수 있는 홍진희 작품을 소개합니다.',
    url: pageUrl,
              ...
              <div className="text-xl leading-[1.8] text-charcoal space-y-6 font-medium">
                {isEnglish ? (
                  ...
                  <>
                    ...
                    <p>
                      홍진희는 씨앗페에 이 캠페인의 대상이 아니라, 동료 예술인과의 연대자로 함께한다
                      — 작품 판매 수익이 금융 차별을 겪는 예술인을 위한 상호부조 대출 기금으로
                      이어지도록.
                    </p>
                  </>
                )}
                  ...
                  {isEnglish ? (
                    ...
                    <>
                      ...
                      <p>
                        ...
                        제목의 작품은 이미 그것을 만드는 과정이 어떤 것이었는지를 묘사한다 — 숲을
                        통한 움직임, 나무들과의 동행. 홍진희는 이 같은 주의 깊은 연대의 마음으로
                        씨앗페에 함께한다: 자신이 사랑하는 현장이 다음 세대에게도 열려 있도록 작품을
                        내놓으면서.
                      </p>
                    </>
                  )}
