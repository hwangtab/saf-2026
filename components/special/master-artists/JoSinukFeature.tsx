                ...
                <p className="text-lg leading-[1.85] text-charcoal font-medium">
                  {isEnglish ? (
                    ...
                    <>
                      ...
                      돌아와 그것이 더 많은 것을 품게 했다 — 책과 사물, 빛, 그리고 삶. 그는 씨앗페에
                      이 캠페인의 대상으로서가 아니라 동료 예술인과의 연대자로서 함께한다. 이 서가
                      위의 작품들이, 오늘 금융 차별을 겪는 예술인 한 사람의 다음 한 달이 될 수
                      있도록.
                    </>
                  )}
                </p>
