...
export default function ActionCard({
  ...
  return (
    <div className="group relative flex flex-col h-full p-8 bg-white border-2 border-gray-200 rounded-2xl shadow-gallery-card hover:border-primary hover:shadow-gallery-hover transition-[box-shadow,border-color] duration-300 overflow-hidden">
