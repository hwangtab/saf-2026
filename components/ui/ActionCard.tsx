...
export default function ActionCard({
  ...
  return (
    <div className="group relative flex flex-col h-full p-8 bg-white border-2 border-gray-200 rounded-2xl shadow-sm hover:-translate-y-1 hover:border-primary hover:shadow-xl transition-[transform,box-shadow,border-color] duration-300 overflow-hidden">
