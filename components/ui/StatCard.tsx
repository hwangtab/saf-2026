...
export default function StatCard({
  ...
  const baseStyles =
    'text-center p-6 bg-white rounded-2xl border border-gray-200 flex flex-col justify-center items-center transition-shadow duration-300 hover:shadow-gallery-hover';
  const variantStyles = {
    default: 'shadow-sm',
