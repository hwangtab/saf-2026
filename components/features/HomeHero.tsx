...
export default async function HomeHero({ locale }: { locale: string }) {
  ...
  const inner = (
    <>
      ...
      {/* 다크 그라디언트 — DESIGN.md §4 PageHero 톤(`from-charcoal-deep via-charcoal to-primary-strong/70`)
          준수. 텍스트 가독성 확보. */}
      <div className="absolute inset-0 bg-gradient-to-b from-charcoal-deep/85 via-charcoal-deep/45 to-charcoal-deep/75" />
