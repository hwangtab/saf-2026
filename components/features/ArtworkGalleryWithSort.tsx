                ...
                <div className="container-max">
                    ...
                    {showArtistNav && (
                        <div className="pb-3 pt-1">
                            <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1 -mx-4 px-4 md:mx-0 md:px-0 md:flex-wrap md:justify-center">
                                {/* Mobile: Horizontal Scroll, Desktop: Wrap/Grid-like but centered */}
                                {uniqueArtists.map((artist) => (
                                    <button
                                        key={artist}
                                        onClick={() => scrollToArtist(artist)}
                                        className="flex-shrink-0 px-3 py-1.5 text-xs sm:text-sm font-medium bg-white border border-gray-200 rounded-full hover:border-primary hover:text-primary hover:bg-primary/5 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50 text-center whitespace-nowrap"
                                    >
                                        {artist}
                                    </button>
                                ))}
