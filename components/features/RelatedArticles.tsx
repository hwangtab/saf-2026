        ...
        {articles.map((article) => {
          ...
          return (
            <a
              ...
              className="group block p-5 bg-white border border-gray-200 rounded-2xl hover:border-primary hover:shadow-gallery-hover transition-[box-shadow,border-color] duration-300"
            >
              {/* Source Badge */}
