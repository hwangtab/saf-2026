    ...
    : [
        {
          ...
          answer: `씨앗페 온라인은 ${CONTACT.ORGANIZATION_NAME}이 주최하는 예술인 상호부조 기금 마련 특별전입니다. ${ARTIST_COUNT}명의 작가가 자발적으로 작품을 출품했으며, 판매 수익이 고금리 시장에 의존하던 예술인들에게 연 5% 고정금리 대출로 전달됩니다.`,
          url: SITE_URL,
        },
        {
