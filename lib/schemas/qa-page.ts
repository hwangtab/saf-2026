 ...
 */
export function generateSAFCoreQA(
  locale: 'ko' | 'en' = 'ko',
  counts?: { artistCount?: number; artworkCount?: number; loanCount?: number }
) {
  ...
  const loanCount = counts?.loanCount ?? LOAN_COUNT;

  const items: QAItem[] = isEnglish
    ? [
        {
          question: 'What is SAF (Seed Art Festival) Online?',
          answer: `SAF Online is a special art exhibition organized by ${CONTACT.ORGANIZATION_NAME_EN} to raise mutual-aid funds for Korean artists facing financial exclusion. ${artistCount} artists voluntarily contributed their works, and sales proceeds go to a low-interest loan fund (5% fixed APR) for fellow artists trapped in predatory lending.`,
          url: `${SITE_URL}/en`,
        },
        {
        ...
        },
        {
          ...
          answer: `The SAF mutual-aid loan has a 95% repayment rate, based on ${loanCount} cumulative loans issued between December 2022 and September 2025. This demonstrates that artists are reliable borrowers when given fair financial terms.`,
          url: `${SITE_URL}/en/our-reality`,
        },
        {
        ...
        },
        {
          ...
          answer: `Artwork prices at SAF Online range from affordable prints to unique original paintings. Most original paintings are priced between KRW 300,000 and KRW 5,000,000. Visit the gallery to see current pricing for all ${artworkCount} works across painting, printmaking, photography, and sculpture.`,
          url: `${SITE_URL}/en/artworks`,
        },
        {
        ...
        },
        {
          ...
          answer: `The SAF Online Gallery at saf2026.com/en/artworks serves as the digital exhibition catalog. Browse all ${artworkCount} artworks by ${artistCount} artists across painting, printmaking, photography, and sculpture. The 2026 offline exhibition archive with poster and visitor reviews is also available.`,
          url: `${SITE_URL}/en/artworks`,
        },
        {
          question: 'Are the exhibiting artists the ones receiving loans?',
          answer: `No. The ${artistCount} exhibiting artists are solidarity participants who voluntarily contributed their works to help fellow artists. Loans go to other artists facing financial exclusion. The exhibitors are helpers, not recipients.`,
    ...
    : [
        {
          ...
          answer: `씨앗페 온라인은 ${CONTACT.ORGANIZATION_NAME}이 주최하는 예술인 상호부조 기금 마련 특별전입니다. ${artistCount}명의 작가가 자발적으로 작품을 출품했으며, 판매 수익이 고금리 시장에 의존하던 예술인들에게 연 5% 고정금리 대출로 전달됩니다.`,
          url: SITE_URL,
        },
        {
          question: '왜 예술인에게 상호부조 기금이 필요한가요?',
          answer:
            '한국 예술인의 84.9%가 제1금융권 접근에 격차가 있습니다. 프로젝트 기반의 불규칙 소득으로 인해 은행 대출이 어렵고, 48.6%가 연 15% 이상의 고금리 시장에 의존하게 됩니다. 채권추심 경험 예술인의 88.3%가 창작 시간의 단절을 경험합니다. 상호부조 기금은 소득 공백기에 저금리 긴급 대출을 제공합니다.',
        ...
        },
        {
          ...
          answer: `씨앗페 상호부조 대출의 상환율은 95%입니다. 이는 2022년 12월부터 2025년 9월까지 누적 ${loanCount}건의 대출 운용 기록에 기반합니다. 공정한 금융 조건이 제공되면 예술인도 신뢰할 수 있는 대출자임을 증명합니다.`,
          url: `${SITE_URL}/our-reality`,
        },
        {
        ...
        },
        {
          ...
          answer: `씨앗페 온라인 작품 가격은 판화·사진 등 소형 작품부터 대형 회화까지 다양합니다. 대부분의 작품은 30만 원에서 500만 원 사이에 형성되어 있으며, 회화·판화·사진·조각 등 ${artworkCount}점의 작품이 출품되어 있습니다.`,
          url: `${SITE_URL}/artworks`,
        },
        {
        ...
        },
        {
          ...
          answer: `아닙니다. ${artistCount}명의 출품 작가는 동료 예술인을 돕기 위해 자발적으로 작품을 내놓은 연대자들입니다. 대출은 금융 소외를 겪는 다른 예술인에게 제공됩니다. 출품 작가는 돕는 사람이지, 수혜자가 아닙니다.`,
