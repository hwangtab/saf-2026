...
export const CONTACT = {
  ...
  REPRESENTATIVE_NAME_EN: 'Inhyeong Seo',
  BUSINESS_REGISTRATION_NUMBER: '385-86-01622',
  MAIL_ORDER_REPORT_NUMBER: '제2021-서울은평-0715호',
  MAIL_ORDER_REPORT_NUMBER_EN: '2021-Seoul Eunpyeong-0715',
...
export const SHIPPING_REFUND_POLICY_VERSION = 'shipping-refund-v1-2026-04-29';
export const FUNDING_TERMS_VERSION = 'funding-terms-v1-2026-06-29';
