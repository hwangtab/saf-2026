...
<body style="margin:0;padding:24px;background:#FAF7F0;font-family:-apple-system,'Apple SD Gothic Neo','Noto Sans KR',sans-serif;color:#1F2937;">
  <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:12px;padding:32px;border:1px solid #E5E7EB;">
    ...
    <p style="margin:0 0 24px;">
      <a href="${safeUrl}" style="display:inline-block;padding:12px 24px;background:#7C2D12;color:#fff;text-decoration:none;border-radius:8px;font-weight:600;">
        청원 페이지로 이동
      </a>
    </p>
